const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_TRADE, ITEM_SUN_STONE, SPECIES_POLITOED}},
    ...
    [SPECIES_MACHOKE]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_GOLEM}},
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 40, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_TRADE, ITEM_SUN_STONE, SPECIES_SLOWKING}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_GENGAR}},
    [SPECIES_ONIX]       = {{EVO_TRADE, ITEM_SUN_STONE, SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE, ITEM_SUN_STONE, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_TRADE, ITEM_SUN_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE, ITEM_SUN_STONE, SPECIES_PORYGON2}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MILOTIC}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE, ITEM_SUN_STONE, SPECIES_HUNTAIL},
                            {EVO_TRADE, ITEM_MOON_STONE, SPECIES_GOREBYSS}},
