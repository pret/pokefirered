...
static const u16 sHoennSpeciesIdToCryId[] =
{
    ...
    [SPECIES_MAGNEZONE - HOENN_MON_SPECIES_START] = CRY_CHIMECHO,
    [SPECIES_BONSLY - HOENN_MON_SPECIES_START] = CRY_CHIMECHO,
    [SPECIES_MIMEJR - HOENN_MON_SPECIES_START] = CRY_CHIMECHO,
};
