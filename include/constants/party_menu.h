...
#define TUTOR_MOVE_BULLET_SEED 0
#define TUTOR_MOVE_CURSE 1
#define TUTOR_MOVE_DOUBLE_TEAM 2
#define TUTOR_MOVE_KNOCK_OFF 3
#define TUTOR_MOVE_LIGHT_SCREEN 4
#define TUTOR_MOVE_REFLECT 5
#define TUTOR_MOVE_SLUDGE 6
#define TUTOR_MOVE_SWORDS_DANCE 7
#define TUTOR_MOVE_TOXIC 8
#define TUTOR_MOVE_BUBBLE_BEAM 9
#define TUTOR_MOVE_PSYBEAM 10
#define TUTOR_MOVE_BULK_UP 11
#define TUTOR_MOVE_CALM_MIND 12
#define TUTOR_MOVE_SPARK 13
#define TUTOR_MOVE_AURORA_BEAM 14
