...
gBattleAnims_Moves::
  ...
  .4byte Move_WING_ATTACK @MOVE_AIR_SLASH
  .4byte Move_WATER_GUN @MOVE_AQUA_JET
  .4byte Move_RECOVER @MOVE_AQUA_RING
  .4byte Move_WATERFALL @MOVE_AQUA_TAIL
  .4byte Move_TACKLE @MOVE_ASSURANCE
  .4byte Move_TACKLE @MOVE_ATTACK_ORDER
  .4byte Move_SHADOW_BALL @MOVE_AURA_SPHERE
  .4byte Move_BLIZZARD @MOVE_AVALANCHE
  .4byte Move_WING_ATTACK @MOVE_BRAVE_BIRD
  .4byte Move_WATER_GUN @MOVE_BRINE
  .4byte Move_BITE @MOVE_BUG_BITE
  .4byte Move_MEGAHORN @MOVE_BUG_BUZZ
  .4byte Move_MACH_PUNCH @MOVE_BULLET_PUNCH
  .4byte Move_ATTRACT @MOVE_CAPTIVATE
  .4byte Move_ZAP_CANNON @MOVE_CHARGE_BEAM
  .4byte Move_METAL_SOUND @MOVE_CHATTER
  .4byte Move_KARATE_CHOP @MOVE_CLOSE_COMBAT
  .4byte Move_METRONOME @MOVE_COPYCAT
  .4byte Move_SLUDGE @MOVE_CROSS_POISON
  .4byte Move_CRUSH_CLAW @MOVE_CRUSH_GRIP
  .4byte Move_FAINT_ATTACK @MOVE_DARK_PULSE
  .4byte Move_FAINT_ATTACK @MOVE_DARK_VOID
  .4byte Move_PROTECT @MOVE_DEFEND_ORDER
  .4byte Move_PROTECT @MOVE_DEFOG
  .4byte Move_ZAP_CANNON @MOVE_DISCHARGE
  .4byte Move_DOUBLE_SLAP @MOVE_DOUBLE_HIT
  .4byte Move_PROTECT @MOVE_DRACO_METEOR
  .4byte Move_DRAGON_RAGE @MOVE_DRAGON_PULSE
  .4byte Move_DRAGON_RAGE @MOVE_DRAGON_RUSH
  .4byte Move_MEGA_PUNCH @MOVE_DRAIN_PUNCH
  .4byte Move_EARTHQUAKE @MOVE_EARTH_POWER
  .4byte Move_PROTECT @MOVE_EMBARGO
  .4byte Move_VINE_WHIP @MOVE_ENERGY_BALL
  .4byte Move_TACKLE @MOVE_FEINT
  .4byte Move_BITE @MOVE_FIRE_FANG
  .4byte Move_FLAME_WHEEL @MOVE_FLARE_BLITZ
  .4byte Move_METEOR_MASH @MOVE_FLASH_CANNON
  .4byte Move_THIEF @MOVE_FLING
  .4byte Move_AEROBLAST @MOVE_FOCUS_BLAST
  .4byte Move_MEGA_PUNCH @MOVE_FORCE_PALM
  .4byte Move_ACID @MOVE_GASTRO_ACID
  .4byte Move_HYPER_BEAM @MOVE_GIGA_IMPACT
  .4byte Move_VINE_WHIP @MOVE_GRASS_KNOT
  .4byte Move_PROTECT @MOVE_GRAVITY
  .4byte Move_PROTECT @MOVE_GUARD_SWAP
  .4byte Move_SLUDGE @MOVE_GUNK_SHOT
  .4byte Move_SHADOW_BALL @MOVE_GYRO_BALL
  .4byte Move_MEGA_PUNCH @MOVE_HAMMER_ARM
  .4byte Move_HEADBUTT @MOVE_HEAD_SMASH
  .4byte Move_PROTECT @MOVE_HEAL_BLOCK
  .4byte Move_PROTECT @MOVE_HEAL_ORDER
  .4byte Move_PROTECT @MOVE_HEALING_WISH
  .4byte Move_PROTECT @MOVE_HEART_SWAP
  .4byte Move_BITE @MOVE_ICE_FANG
  .4byte Move_ICY_WIND @MOVE_ICE_SHARD
  .4byte Move_HEADBUTT @MOVE_IRON_HEAD
  .4byte Move_PROTECT @MOVE_JUDGMENT
  .4byte Move_METRONOME @MOVE_LAST_RESORT
  .4byte Move_HEAT_WAVE @MOVE_LAVA_PLUME
  .4byte Move_RAZOR_LEAF @MOVE_LEAF_STORM
  .4byte Move_PROTECT @MOVE_LUCKY_CHANT
  .4byte Move_PETAL_DANCE @MOVE_LUNAR_DANCE
  .4byte Move_HEAT_WAVE @MOVE_MAGMA_STORM
  .4byte Move_EGG_BOMB @MOVE_MAGNET_BOMB
  .4byte Move_PROTECT @MOVE_MAGNET_RISE
  .4byte Move_PROTECT @MOVE_ME_FIRST
  .4byte Move_SELF_DESTRUCT @MOVE_METAL_BURST
  .4byte Move_PROTECT @MOVE_MIRACLE_EYE
  .4byte Move_TACKLE @MOVE_MIRROR_SHOT
  .4byte Move_EGG_BOMB @MOVE_MUD_BOMB
  .4byte Move_SWORDS_DANCE @MOVE_NASTY_PLOT
  .4byte Move_TACKLE @MOVE_NATURAL_GIFT
  .4byte Move_SLASH @MOVE_NIGHT_SLASH
  .4byte Move_ICY_WIND @MOVE_OMINOUS_WIND
  .4byte Move_THIEF @MOVE_PAYBACK
  .4byte Move_TACKLE @MOVE_PLUCK
  .4byte Move_POISON_STING @MOVE_POISON_JAB
  .4byte Move_ROCK_SLIDE @MOVE_POWER_GEM
  .4byte Move_PROTECT @MOVE_POWER_SWAP
  .4byte Move_PROTECT @MOVE_POWER_TRICK
  .4byte Move_VINE_WHIP @MOVE_POWER_WHIP
  .4byte Move_CUT @MOVE_PSYCHO_CUT
  .4byte Move_PROTECT @MOVE_PSYCHO_SHIFT
  .4byte Move_TACKLE @MOVE_PUNISHMENT
  .4byte Move_ROAR @MOVE_ROAR_OF_TIME
  .4byte Move_HEADBUTT @MOVE_ROCK_CLIMB
  .4byte Move_AGILITY @MOVE_ROCK_POLISH
  .4byte Move_ANCIENT_POWER @MOVE_ROCK_WRECKER
  .4byte Move_RECOVER @MOVE_ROOST
  .4byte Move_EGG_BOMB @MOVE_SEED_BOMB
  .4byte Move_LEECH_SEED @MOVE_SEED_FLARE
  .4byte Move_METAL_CLAW @MOVE_SHADOW_CLAW
  .4byte Move_FAINT_ATTACK @MOVE_SHADOW_FORCE
  .4byte Move_QUICK_ATTACK @MOVE_SHADOW_SNEAK
  .4byte Move_HYPER_BEAM @MOVE_SPACIAL_REND
  .4byte Move_SPIKES @MOVE_STEALTH_ROCK
  .4byte Move_ANCIENT_POWER  @MOVE_STONE_EDGE
  .4byte Move_MEGA_PUNCH @MOVE_SUCKER_PUNCH
  .4byte Move_PROTECT @MOVE_SWITCHEROO
  .4byte Move_AGILITY @MOVE_TAILWIND
  .4byte Move_BITE @MOVE_THUNDER_FANG
  .4byte Move_SPIKES @MOVE_TOXIC_SPIKES
  .4byte Move_PROTECT @MOVE_TRICK_ROOM
  .4byte Move_SWIFT @MOVE_TRUMP_CARD
  .4byte Move_PROTECT @MOVE_U_TURN
  .4byte Move_THUNDER_WAVE @MOVE_VACUUM_WAVE
  .4byte Move_DOUBLE_SLAP @MOVE_WAKE_UP_SLAP
  .4byte Move_CRABHAMMER @MOVE_WOOD_HAMMER
  .4byte Move_PROTECT @MOVE_WORRY_SEED
  .4byte Move_TACKLE @MOVE_WRING_OUT
  .4byte Move_CROSS_CHOP @MOVE_X_SCISSOR
  .4byte Move_HEADBUTT @MOVE_ZEN_HEADBUTT
  .4byte Move_PROTECT @MOVE_ACUPRESSURE
...
gBattleAnims_General::
	.4byte General_CastformChange           @ B_ANIM_MAGMORTAR_CHANGE
