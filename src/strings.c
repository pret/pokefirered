...
const u8 gText_Dratini_2800Coins[] = _("AMBIPOM{CLEAR_TO 0x4B}{FONT_SMALL} 2,800 COINS");
...
const u8 gText_Pinsir_2500Coins[] = _("AMBIPOM{CLEAR_TO 0x4B}{FONT_SMALL} 2,500 COINS");
