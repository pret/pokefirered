...
#define PAGE_SWAP TRUE //if true auttomaticaly swap the naming screen page to lower case on write the first caracter.
...
#define CONFUSION_DMG_CHANCE_UPDATE TRUE //if true the chance that the pokemon will be damaged by confusion becames 33% instead of 50%.
