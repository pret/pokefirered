...
sub_80688E4: @ 80688E4
	...
	orrs r0, r4
	strb r0, [r5, 0x1]
	ldr r3, _08068968 @ =gUnknown_202063C
	ldrb r1, [r5, 0x4]
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	...
	b _0806896E
	.align 2, 0
_08068968: .4byte gUnknown_202063C
_0806896C:
	movs r0, 0x1
_0806896E:
	pop {r4,r5}
...
sub_80689F4: @ 80689F4
	...
	ands r0, r1
	strb r0, [r5, 0x1]
	ldr r4, _08068A58 @ =gUnknown_202063C
	ldrb r0, [r5, 0x4]
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
...
sub_8068EB4: @ 8068EB4
	...
	movs r0, 0
	ldrsb r0, [r4, r0]
	ldr r2, _08068F14 @ =gUnknown_2021BC8
	adds r0, r1
	ldrh r2, [r2]
	adds r0, r2
	lsls r0, 16
	...
	movs r0, 0
	ldrsb r0, [r3, r0]
	ldr r2, _08068F18 @ =gUnknown_2021BCA
	adds r0, r1
	ldrh r2, [r2]
	adds r0, r2
	lsls r0, 16
	...
	b _08068F4A
	.align 2, 0
_08068F14: .4byte gUnknown_2021BC8
_08068F18: .4byte gUnknown_2021BCA
_08068F1C:
	mov r0, r12
	ldrh r1, [r0, 0x24]
	ldrh r2, [r0, 0x20]
...
sub_8068FD0: @ 8068FD0
	...
	movs r4, 0x3F
_08068FD6:
	ldr r0, _08069004 @ =gUnknown_202063C
	adds r2, r5, r0
	adds r0, r2, 0
	adds r0, 0x3E
	ldrb r1, [r0]
...
_08068FF6:
	...
	bx r0
	.align 2, 0
_08069004: .4byte gUnknown_202063C
...
sub_806900C: @ 806900C
	...
	lsrs r5, r0, 24
	movs r3, 0
	ldr r6, _08069040 @ =gUnknown_202063C
	movs r4, 0
_08069018:
	adds r2, r4, r6
	adds r0, r2, 0
	...
	b _08069052
	.align 2, 0
_08069040: .4byte gUnknown_202063C
...
_0806908A:
	...
	bx r0
	.align 2, 0
_08069090: .4byte gUnknown_202063C
...
sub_8069094: @ 8069094
	...
	b _08069116
	.align 2, 0
_080690F8: .4byte gUnknown_202063C
...
sub_8069124: @ 8069124
	...
	cmp r4, 0
	beq _08069154
	ldr r0, _08069150 @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
	...
	b _08069160
	.align 2, 0
_08069150: .4byte gUnknown_202063C
_08069154:
	ldr r1, _08069168 @ =gUnknown_202063C
	lsls r0, r3, 4
	adds r0, r3
	lsls r0, 2
	adds r0, r1
...
_08069160:
	...
	bx r0
	.align 2, 0
_08069168: .4byte gUnknown_202063C
...
_08069182:
	movs r3, 0
	ldr r0, _080691A0 @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_0806919A:
	...
	bx r1
	.align 2, 0
_080691A0: .4byte gUnknown_202063C
...
sub_80691A4: @ 80691A4
	...
	cmp r2, 0x40
	beq _080691CA
	ldr r0, _080691D0 @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_080691CA:
	...
	bx r0
	.align 2, 0
_080691D0: .4byte gUnknown_202063C
...
sub_8069294: @ 8069294
	...
	cmp r2, 0x40
	beq _080692B8
	ldr r0, _080692BC @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_080692B8:
	...
	b _080692C2
	.align 2, 0
_080692BC: .4byte gUnknown_202063C
_080692C0:
	movs r0, 0x1
_080692C2:
	pop {r1}
