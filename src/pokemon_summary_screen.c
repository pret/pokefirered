...
static void PokeSum_DrawMoveTypeIcons(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        BlitMoveInfoIcon(sMonSummaryScreen->windowIds[5], MOVEICON_TYPE(sMonSummaryScreen->moveTypes[i]), 3, GetMoveNamePrinterYpos(i));
    }

    if (sMonSummaryScreen->mode == PSS_MODE_SELECT_MOVE)
        BlitMoveInfoIcon(sMonSummaryScreen->windowIds[5], MOVEICON_TYPE(sMonSummaryScreen->moveTypes[4]), 3, GetMoveNamePrinterYpos(4));
}
...
static void PokeSum_PrintMonTypeIcons(void)
{
    ...
    case PSS_PAGE_INFO:
        if (!sMonSummaryScreen->isEgg)
        {
            BlitMoveInfoIcon(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], MOVEICON_TYPE(sMonSummaryScreen->monTypes[0]), 47, 35);

            if (sMonSummaryScreen->monTypes[0] != sMonSummaryScreen->monTypes[1])
                BlitMoveInfoIcon(sMonSummaryScreen->windowIds[POKESUM_WIN_RIGHT_PANE], MOVEICON_TYPE(sMonSummaryScreen->monTypes[1]), 83, 35);
        }
        break;
    case PSS_PAGE_SKILLS:
        break;
    ...
    case PSS_PAGE_MOVES_INFO:
        ...
        BlitMoveInfoIcon(sMonSummaryScreen->windowIds[6], MOVEICON_TYPE(sMonSummaryScreen->monTypes[0]), 0, 3);

        if (sMonSummaryScreen->monTypes[0] != sMonSummaryScreen->monTypes[1])
            BlitMoveInfoIcon(sMonSummaryScreen->windowIds[6], MOVEICON_TYPE(sMonSummaryScreen->monTypes[1]), 36, 3);
