...
_080432B6:
	pop {r1}
	bx r1
	thumb_func_end sub_8043298

	thumb_func_start sub_80432BC
sub_80432BC: @ 80432BC
	push {lr}
	lsls r0, 16
	lsrs r1, r0, 16
...
_080432DA:
	pop {r1}
	bx r1
	thumb_func_end sub_80432BC

	thumb_func_start sub_80432E0
sub_80432E0: @ 80432E0
	push {lr}
	lsls r0, 16
	lsrs r1, r0, 16
...
_080432FE:
	pop {r1}
	bx r1
	thumb_func_end sub_80432E0

	thumb_func_start sub_8043304
sub_8043304: @ 8043304
	push {lr}
	lsls r0, 16
	lsrs r0, 16
...
_0804355A:
	...
	pop {r0}
	bx r0
	thumb_func_end sub_8043458

	thumb_func_start sub_804356C
sub_804356C: @ 804356C
	push {r4-r7,lr}
	mov r7, r9
	mov r6, r8
...
sub_80440BC: @ 80440BC
	...
	pop {r1}
	bx r1
	thumb_func_end sub_80440BC

	thumb_func_start sub_80440F4
sub_80440F4: @ 80440F4
	push {r4,r5,lr}
	adds r3, r2, 0
	lsls r0, 16
...
_080441B4: .4byte gUnknown_82380CC
	thumb_func_end sub_8044180

	thumb_func_start sub_80441B8
sub_80441B8: @ 80441B8
	push {r4,lr}
	lsls r0, 16
	lsrs r3, r0, 16
...
_080441EC:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_80441B8

	thumb_func_start sub_80441F4
sub_80441F4: @ 80441F4
	lsls r0, 16
	lsrs r0, 16
...
_08044230: .4byte gUnknown_825DE24
	thumb_func_end sub_804420C

	thumb_func_start sub_8044234
sub_8044234: @ 8044234
	push {r4,lr}
	lsls r4, r1, 24
	lsrs r4, 24
...
_08044258: .4byte gUnknown_825DE24
	thumb_func_end sub_8044234

	thumb_func_start sub_804425C
sub_804425C: @ 804425C
	push {r4,lr}
	sub sp, 0x8
	adds r4, r0, 0
	...
	pop {r1}
	bx r1
	thumb_func_end sub_804425C

	thumb_func_start sub_8044288
sub_8044288: @ 8044288
	push {r4,r5,lr}
	adds r5, r1, 0
...
_080442D2:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_8044288

	thumb_func_start sub_80442D8
sub_80442D8: @ 80442D8
	push {lr}
	bl sub_80442E4
	pop {r0}
	bx r0
	thumb_func_end sub_80442D8

	thumb_func_start sub_80442E4
sub_80442E4: @ 80442E4
	push {r4-r6,lr}
	sub sp, 0x4
	adds r5, r0, 0
