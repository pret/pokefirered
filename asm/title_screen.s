...
_080797CA:
	...
	cmp r1, 0x40
	beq _08079834
	ldr r0, _0807982C @ =gUnknown_202063C
	mov r12, r0
	lsls r0, r1, 4
	adds r0, r1
	lsls r6, r0, 2
...
_0807982C: .4byte gUnknown_202063C
...
sub_8079A40: @ 8079A40
	...
	cmp r1, 0x40
	beq _08079A74
	ldr r3, _08079A80 @ =gUnknown_202063C
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r1, r3, 0
...
_08079A80: .4byte gUnknown_202063C
...
sub_8079A88: @ 8079A88
	...
	cmp r2, 0x40
	beq _08079AA0
	ldr r0, _08079AA4 @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_08079AA0:
	...
	bx r0
	.align 2, 0
_08079AA4: .4byte gUnknown_202063C
...
sub_8079AA8: @ 8079AA8
	...
	b _08079ACE
_08079AB6:
	ldr r1, _08079AD4 @ =gUnknown_202063C
	lsls r0, r2, 4
	adds r0, r2
	lsls r0, 2
	adds r0, r1
...
_08079ACE:
	...
	bx r1
	.align 2, 0
_08079AD4: .4byte gUnknown_202063C
