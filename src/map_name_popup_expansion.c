...
//     [MAPSEC_BIRTH_ISLAND_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
...
//     [MAPSEC_ALTERING_CAVE_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
//     [MAPSEC_NAVEL_ROCK_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
...
//     [MAPSEC_BIRTH_ISLAND_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
...
//     [MAPSEC_ALTERING_CAVE_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
//     [MAPSEC_NAVEL_ROCK_FRLG - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    {
        popUpThemeId = MAPPOPUP_THEME_WOOD; // sRegionMapSectionId_To_PopUpThemeIdMapping[regionMapSectionId];
