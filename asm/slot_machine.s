...
_08140CC6:
	...
	adds r5, r0
	lsls r5, 2
	ldr r0, _08140D6C @ =gUnknown_202063C
	adds r5, r0
	adds r0, r5, 0
	adds r1, r4, 0
	bl StartSpriteAnim
...
_08140D6C: .4byte gUnknown_202063C
...
sub_8140E9C: @ 8140E9C
	...
	mov r9, r0
	ldr r0, _08140F28 @ =gUnknown_202063C
	mov r8, r0
	movs r7, 0x85
	lsls r7, 16
	movs r6, 0xAA
...
_08140F28: .4byte gUnknown_202063C
...
sub_8140FC4: @ 8140FC4
	...
	adds r0, r2
	lsls r0, 2
	ldr r4, _0814101C @ =gUnknown_202063C
	adds r0, r4
	str r0, [r1, 0x68]
	adds r0, r6, 0
	movs r1, 0xE0
...
_0814101C: .4byte gUnknown_202063C
