const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BUDEW, gMonBackPic_Mew),
    ...
    SPECIES_SPRITE(MIME_JR, gMonBackPic_Cleffa),
    SPECIES_SPRITE(AMBIPOM, gMonBackPic_Igglybuff),
    ...
    SPECIES_SPRITE(WEAVILE, gMonBackPic_UnownA),
    SPECIES_SPRITE(GLISCOR, gMonBackPic_Wobbuffet),
    ...
    SPECIES_SPRITE(PROBOPASS, gMonBackPic_Smeargle),
    ...
    SPECIES_SPRITE(ROSERADE, gMonBackPic_Raikou),
    SPECIES_SPRITE(TANGROWTH, gMonBackPic_Entei),
    SPECIES_SPRITE(YANMEGA, gMonBackPic_Suicune),
    ...
    SPECIES_SPRITE(MISMAGIUS, gMonBackPic_Lugia),
    SPECIES_SPRITE(HONCHKROW, gMonBackPic_HoOh),
    SPECIES_SPRITE(FROSLASS, gMonBackPic_Celebi),
    ...
    SPECIES_SPRITE(ELECTIVIRE, gMonBackPic_Shedinja),
    ...
    SPECIES_SPRITE(HAPPINY, gMonBackPic_Luvdisc),
    ...
    SPECIES_SPRITE(TOGEKISS, gMonBackPic_Wynaut),
    ...
    SPECIES_SPRITE(MAGMORTAR, gMonBackPic_Castform),
    ...
    SPECIES_SPRITE(MUNCHLAX, gMonBackPic_Regirock),
    SPECIES_SPRITE(LICKILICKY, gMonBackPic_Regice),
    SPECIES_SPRITE(MAGNEZONE, gMonBackPic_Registeel),
    SPECIES_SPRITE(PORYGON_Z, gMonBackPic_Kyogre),
    SPECIES_SPRITE(GALLADE, gMonBackPic_Groudon),
    SPECIES_SPRITE(DUSKNOIR, gMonBackPic_Rayquaza),
    SPECIES_SPRITE(RHYPERIOR, gMonBackPic_Latias),
    SPECIES_SPRITE(MAMOSWINE, gMonBackPic_Latios),
    SPECIES_SPRITE(LEAFEON, gMonBackPic_Jirachi),
    SPECIES_SPRITE(GLACEON, gMonBackPic_Deoxys),
