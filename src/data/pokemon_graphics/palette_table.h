const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BUDEW, gMonPalette_Mew),
    ...
    SPECIES_PAL(MIME_JR, gMonPalette_Cleffa),
    SPECIES_PAL(AMBIPOM, gMonPalette_Igglybuff),
    ...
    SPECIES_PAL(WEAVILE, gMonPalette_Unown),
    SPECIES_PAL(GLISCOR, gMonPalette_Wobbuffet),
    ...
    SPECIES_PAL(PROBOPASS, gMonPalette_Smeargle),
    ...
    SPECIES_PAL(ROSERADE, gMonPalette_Raikou),
    SPECIES_PAL(TANGROWTH, gMonPalette_Entei),
    SPECIES_PAL(YANMEGA, gMonPalette_Suicune),
    ...
    SPECIES_PAL(MISMAGIUS, gMonPalette_Lugia),
    SPECIES_PAL(HONCHKROW, gMonPalette_HoOh),
    SPECIES_PAL(FROSLASS, gMonPalette_Celebi),
    ...
    SPECIES_PAL(ELECTIVIRE, gMonPalette_Shedinja),
    ...
    SPECIES_PAL(HAPPINY, gMonPalette_Luvdisc),
    ...
    SPECIES_PAL(TOGEKISS, gMonPalette_Wynaut),
    ...
    SPECIES_PAL(MAGMORTAR, gMonPalette_Castform),
    ...
    SPECIES_PAL(MUNCHLAX, gMonPalette_Regirock),
    SPECIES_PAL(LICKILICKY, gMonPalette_Regice),
    SPECIES_PAL(MAGNEZONE, gMonPalette_Registeel),
    SPECIES_PAL(PORYGON_Z, gMonPalette_Kyogre),
    SPECIES_PAL(GALLADE, gMonPalette_Groudon),
    SPECIES_PAL(DUSKNOIR, gMonPalette_Rayquaza),
    SPECIES_PAL(RHYPERIOR, gMonPalette_Latias),
    SPECIES_PAL(MAMOSWINE, gMonPalette_Latios),
    SPECIES_PAL(LEAFEON, gMonPalette_Jirachi),
    SPECIES_PAL(GLACEON, gMonPalette_Deoxys),
