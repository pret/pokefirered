...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_YOUNGSTER_CESAR, TRAINER_YOUNGSTER_CESAR}, MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_CRISTIAN, TRAINER_BUG_CATCHER_CRISTIAN_2, SKIP, TRAINER_BUG_CATCHER_CRISTIAN_3, SKIP, TRAINER_BUG_CATCHER_CRISTIAN_4},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_GREG, TRAINER_BUG_CATCHER_GREG},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_JAMES, TRAINER_BUG_CATCHER_JAMES},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_JAZMIN, TRAINER_LASS_JAZMIN_2, SKIP, TRAINER_LASS_JAZMIN_3},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_SUSANA, TRAINER_LASS_SUSANA},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_ROBERTA, TRAINER_LASS_ROBERTA},
      MAP(MAP_ROUTE3) },
