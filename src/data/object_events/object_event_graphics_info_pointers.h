...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_OBJ_EVENT_GFX] = {
    ...
    [OBJ_EVENT_GFX_ROSERADE]                   = &gObjectEventGraphicsInfo_Raikou,
    [OBJ_EVENT_GFX_MISMAGIUS]                    = &gObjectEventGraphicsInfo_Lugia,
    [OBJ_EVENT_GFX_HONCHKROW]                    = &gObjectEventGraphicsInfo_HoOh,
    [OBJ_EVENT_GFX_FROSLASS]                   = &gObjectEventGraphicsInfo_Celebi,
    [OBJ_EVENT_GFX_KABUTO]                   = &gObjectEventGraphicsInfo_Kabuto,
    [OBJ_EVENT_GFX_GLACEON_D]                 = &gObjectEventGraphicsInfo_DeoxysD,
    [OBJ_EVENT_GFX_GLACEON_A]                 = &gObjectEventGraphicsInfo_DeoxysA,
    [OBJ_EVENT_GFX_GLACEON_N]                 = &gObjectEventGraphicsInfo_DeoxysN,
