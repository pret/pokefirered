const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BUDEW, gMonShinyPalette_Mew),
    ...
    SPECIES_SHINY_PAL(MIME_JR, gMonShinyPalette_Cleffa),
    SPECIES_SHINY_PAL(AMBIPOM, gMonShinyPalette_Igglybuff),
    ...
    SPECIES_SHINY_PAL(WEAVILE, gMonShinyPalette_Unown),
    SPECIES_SHINY_PAL(GLISCOR, gMonShinyPalette_Wobbuffet),
    ...
    SPECIES_SHINY_PAL(PROBOPASS, gMonShinyPalette_Smeargle),
    ...
    SPECIES_SHINY_PAL(ROSERADE, gMonShinyPalette_Raikou),
    SPECIES_SHINY_PAL(TANGROWTH, gMonShinyPalette_Entei),
    SPECIES_SHINY_PAL(YANMEGA, gMonShinyPalette_Suicune),
    ...
    SPECIES_SHINY_PAL(MISMAGIUS, gMonShinyPalette_Lugia),
    SPECIES_SHINY_PAL(HONCHKROW, gMonShinyPalette_HoOh),
    SPECIES_SHINY_PAL(FROSLASS, gMonShinyPalette_Celebi),
    ...
    SPECIES_SHINY_PAL(ELECTIVIRE, gMonShinyPalette_Shedinja),
    ...
    SPECIES_SHINY_PAL(HAPPINY, gMonShinyPalette_Luvdisc),
    ...
    SPECIES_SHINY_PAL(TOGEKISS, gMonShinyPalette_Wynaut),
    ...
    SPECIES_SHINY_PAL(MAGMORTAR, gMonShinyPalette_Castform),
    ...
    SPECIES_SHINY_PAL(MUNCHLAX, gMonShinyPalette_Regirock),
    SPECIES_SHINY_PAL(LICKILICKY, gMonShinyPalette_Regice),
    SPECIES_SHINY_PAL(MAGNEZONE, gMonShinyPalette_Registeel),
    SPECIES_SHINY_PAL(PORYGON_Z, gMonShinyPalette_Kyogre),
    SPECIES_SHINY_PAL(GALLADE, gMonShinyPalette_Groudon),
    SPECIES_SHINY_PAL(DUSKNOIR, gMonShinyPalette_Rayquaza),
    SPECIES_SHINY_PAL(RHYPERIOR, gMonShinyPalette_Latias),
    SPECIES_SHINY_PAL(MAMOSWINE, gMonShinyPalette_Latios),
    SPECIES_SHINY_PAL(LEAFEON, gMonShinyPalette_Jirachi),
    SPECIES_SHINY_PAL(GLACEON, gMonShinyPalette_Deoxys),
