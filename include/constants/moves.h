...
#define MOVETUTOR_BULLET_SEED 0
#define MOVETUTOR_CURSE 1
#define MOVETUTOR_DOUBLE_TEAM 2
#define MOVETUTOR_KNOCK_OFF 3
#define MOVETUTOR_LIGHT_SCREEN 4
#define MOVETUTOR_REFLECT 5
#define MOVETUTOR_SLUDGE 6
#define MOVETUTOR_SWORDS_DANCE 7
#define MOVETUTOR_TOXIC 8
#define MOVETUTOR_BUBBLE_BEAM 9
#define MOVETUTOR_PSYBEAM 10
#define MOVETUTOR_BULK_UP 11
#define MOVETUTOR_CALM_MIND 12
#define MOVETUTOR_SPARK 13
#define MOVETUTOR_AURORA_BEAM 14
