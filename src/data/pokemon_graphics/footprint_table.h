const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BUDEW] = gMonFootprint_Mew,
    ...
    [SPECIES_MIME_JR] = gMonFootprint_Cleffa,
    [SPECIES_AMBIPOM] = gMonFootprint_Igglybuff,
    ...
    [SPECIES_WEAVILE] = gMonFootprint_Unown,
    [SPECIES_GLISCOR] = gMonFootprint_Wobbuffet,
    ...
    [SPECIES_PROBOPASS] = gMonFootprint_Smeargle,
    ...
    [SPECIES_ROSERADE] = gMonFootprint_Raikou,
    [SPECIES_TANGROWTH] = gMonFootprint_Entei,
    [SPECIES_YANMEGA] = gMonFootprint_Suicune,
    [SPECIES_LARVITAR] = gMonFootprint_Larvitar,
    [SPECIES_PUPITAR] = gMonFootprint_Pupitar,
    [SPECIES_TYRANITAR] = gMonFootprint_Tyranitar,
    [SPECIES_MISMAGIUS] = gMonFootprint_Lugia,
    [SPECIES_HONCHKROW] = gMonFootprint_HoOh,
    [SPECIES_FROSLASS] = gMonFootprint_Celebi,
    ...
    [SPECIES_ELECTIVIRE] = gMonFootprint_Shedinja,
    ...
    [SPECIES_HAPPINY] = gMonFootprint_Luvdisc,
    ...
    [SPECIES_TOGEKISS] = gMonFootprint_Wynaut,
    ...
    [SPECIES_MAGMORTAR] = gMonFootprint_Castform,
    ...
    [SPECIES_MUNCHLAX] = gMonFootprint_Regirock,
    [SPECIES_LICKILICKY] = gMonFootprint_Regice,
    [SPECIES_MAGNEZONE] = gMonFootprint_Registeel,
    [SPECIES_PORYGON_Z] = gMonFootprint_Kyogre,
    [SPECIES_GALLADE] = gMonFootprint_Groudon,
    [SPECIES_DUSKNOIR] = gMonFootprint_Rayquaza,
    [SPECIES_RHYPERIOR] = gMonFootprint_Latias,
    [SPECIES_MAMOSWINE] = gMonFootprint_Latios,
    [SPECIES_LEAFEON] = gMonFootprint_Jirachi,
    [SPECIES_GLACEON] = gMonFootprint_Deoxys,
