...
const u8 *const gItemEffectTable[] =
    {
        ...
        [ITEM_DRAGON_SCALE -
            ITEM_POTION] = sItemEffect_DragonScale,
        [ITEM_KINGS_ROCK -
            ITEM_POTION] = sItemEffect_KingsRock,
        [ITEM_METAL_COAT -
            ITEM_POTION] = sItemEffect_MetalCoat,
        [ITEM_UP_GRADE -
            ITEM_POTION] = sItemEffect_UpGrade,
        [ITEM_DEEP_SEA_SCALE -
            ITEM_POTION] = sItemEffect_DeepSeaScale,
        [ITEM_DEEP_SEA_TOOTH -
            ITEM_POTION] = sItemEffect_DeepSeaTooth,
        [ITEM_CHERI_BERRY -
