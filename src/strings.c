...
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("You may replace this egg with a\nSMEARGLE that knows any move and has\nan even EV spread in Pokémon Showdown.");
