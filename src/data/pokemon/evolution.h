const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MANTYKE]    = {{EVO_LEVEL, 20, SPECIES_MANTINE}},
    [SPECIES_SNOVER]     = {{EVO_LEVEL, 40, SPECIES_ABOMASNOW}},

    // Gen 4 cross-gen evolutions (update existing Pokemon)
    ...
    [SPECIES_RHYDON]     = {{EVO_TRADE_ITEM, ITEM_NONE, SPECIES_RHYPERIOR}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 36, SPECIES_TANGROWTH}},
    [SPECIES_ELECTABUZZ] = {{EVO_TRADE_ITEM, ITEM_NONE, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]     = {{EVO_TRADE_ITEM, ITEM_NONE, SPECIES_MAGMORTAR}},
    ...
    [SPECIES_GLIGAR]     = {{EVO_LEVEL, 35, SPECIES_GLISCOR}},
    [SPECIES_SWINUB]     = {{EVO_LEVEL, 33, SPECIES_PILOSWINE}},
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 44, SPECIES_MAMOSWINE}},
    [SPECIES_PORYGON2]   = {{EVO_TRADE_ITEM, ITEM_NONE, SPECIES_PORYGON_Z}},
    [SPECIES_KIRLIA]     = {{EVO_LEVEL, 30, SPECIES_GARDEVOIR},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_GALLADE}},
    [SPECIES_NOSEPASS]   = {{EVO_LEVEL, 35, SPECIES_PROBOPASS}},
    [SPECIES_DUSCLOPS]   = {{EVO_TRADE_ITEM, ITEM_NONE, SPECIES_DUSKNOIR}},
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 42, SPECIES_GLALIE},
