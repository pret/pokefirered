const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BUDEW, gMonFrontPic_Mew),
    ...
    SPECIES_SPRITE(MIME_JR, gMonFrontPic_Cleffa),
    SPECIES_SPRITE(AMBIPOM, gMonFrontPic_Igglybuff),
    ...
    SPECIES_SPRITE(WEAVILE, gMonFrontPic_UnownA),
    SPECIES_SPRITE(GLISCOR, gMonFrontPic_Wobbuffet),
    ...
    SPECIES_SPRITE(PROBOPASS, gMonFrontPic_Smeargle),
    ...
    SPECIES_SPRITE(ROSERADE, gMonFrontPic_Raikou),
    SPECIES_SPRITE(TANGROWTH, gMonFrontPic_Entei),
    SPECIES_SPRITE(YANMEGA, gMonFrontPic_Suicune),
    ...
    SPECIES_SPRITE(MISMAGIUS, gMonFrontPic_Lugia),
    SPECIES_SPRITE(HONCHKROW, gMonFrontPic_HoOh),
    SPECIES_SPRITE(FROSLASS, gMonFrontPic_Celebi),
    ...
    SPECIES_SPRITE(ELECTIVIRE, gMonFrontPic_Shedinja),
    ...
    SPECIES_SPRITE(HAPPINY, gMonFrontPic_Luvdisc),
    ...
    SPECIES_SPRITE(TOGEKISS, gMonFrontPic_Wynaut),
    ...
    SPECIES_SPRITE(MAGMORTAR, gMonFrontPic_Castform),
    ...
    SPECIES_SPRITE(MUNCHLAX, gMonFrontPic_Regirock),
    SPECIES_SPRITE(LICKILICKY, gMonFrontPic_Regice),
    SPECIES_SPRITE(MAGNEZONE, gMonFrontPic_Registeel),
    SPECIES_SPRITE(PORYGON_Z, gMonFrontPic_Kyogre),
    SPECIES_SPRITE(GALLADE, gMonFrontPic_Groudon),
    SPECIES_SPRITE(DUSKNOIR, gMonFrontPic_Rayquaza),
    SPECIES_SPRITE(RHYPERIOR, gMonFrontPic_Latias),
    SPECIES_SPRITE(MAMOSWINE, gMonFrontPic_Latios),
    SPECIES_SPRITE(LEAFEON, gMonFrontPic_Jirachi),
    SPECIES_SPRITE(GLACEON, gMonFrontPic_Deoxys),
