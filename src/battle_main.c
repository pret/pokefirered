...
u16 gBattle_WIN1H = 0;
u16 gBattle_WIN1V = 0;
u8 gDisplayedStringBattle[300] = {0};
u8 gBattleTextBuff1[TEXT_BUFF_ARRAY_COUNT] = {0};
u8 gBattleTextBuff2[TEXT_BUFF_ARRAY_COUNT] = {0};
u8 gBattleTextBuff3[TEXT_BUFF_ARRAY_COUNT] = {0};
...
static u32 sFlickerArray[25] = {0};
u32 gBattleTypeFlags = 0;
u8 gBattleTerrain = 0;
u32 gUnusedFirstBattleVar1 = 0;
struct MultiBattlePokemonTx gMultiPartnerParty[3] = {0};
u8 *gBattleAnimBgTileBuffer = NULL;
u8 *gBattleAnimBgTilemapBuffer = NULL;
static u16 *sUnknownDebugSpriteDataBuffer = NULL;
u8 gBattleBufferA[MAX_BATTLERS_COUNT][0x200] = {0};
u8 gBattleBufferB[MAX_BATTLERS_COUNT][0x200] = {0};
u8 gActiveBattler = 0;
u32 gBattleControllerExecFlags = 0;
u8 gBattlersCount = 0;
u16 gBattlerPartyIndexes[MAX_BATTLERS_COUNT] = {0};
u8 gBattlerPositions[MAX_BATTLERS_COUNT] = {0};
u8 gActionsByTurnOrder[MAX_BATTLERS_COUNT] = {0};
u8 gBattlerByTurnOrder[MAX_BATTLERS_COUNT] = {0};
u8 gCurrentTurnActionNumber = 0;
u8 gCurrentActionFuncId = 0;
struct BattlePokemon gBattleMons[MAX_BATTLERS_COUNT] = {0};
u8 gBattlerSpriteIds[MAX_BATTLERS_COUNT] = {0};
u8 gCurrMovePos = 0;
u8 gChosenMovePos = 0;
u16 gCurrentMove = 0;
u16 gChosenMove = 0;
...
s32 gHpDealt = 0;
s32 gTakenDmg[MAX_BATTLERS_COUNT] = {0};
u16 gLastUsedItem = 0;
u8 gLastUsedAbility = 0;
u8 gBattlerAttacker = 0;
u8 gBattlerTarget = 0;
u8 gBattlerFainted = 0;
u8 gEffectBattler = 0;
...
u32 gUnusedBattleMainVar = 0;
u8 gChosenActionByBattler[MAX_BATTLERS_COUNT] = {0};
const u8 *gSelectionBattleScripts[MAX_BATTLERS_COUNT] = {NULL};
u16 gLastPrintedMoves[MAX_BATTLERS_COUNT] = {0};
u16 gLastMoves[MAX_BATTLERS_COUNT] = {0};
u16 gLastLandedMoves[MAX_BATTLERS_COUNT] = {0};
u16 gLastHitByType[MAX_BATTLERS_COUNT] = {0};
u16 gLastResultingMoves[MAX_BATTLERS_COUNT] = {0};
u16 gLockedMoves[MAX_BATTLERS_COUNT] = {0};
u8 gLastHitBy[MAX_BATTLERS_COUNT] = {0};
u16 gChosenMoveByBattler[MAX_BATTLERS_COUNT] = {0};
u8 gMoveResultFlags = 0;
u32 gHitMarker = 0;
static u8 sUnusedBattlersArray[MAX_BATTLERS_COUNT] = {0};
u8 gTakenDmgByBattler[MAX_BATTLERS_COUNT] = {0};
u8 gUnusedFirstBattleVar2 = 0;
u16 gSideStatuses[2] = {0};
struct SideTimer gSideTimers[2] = {0};
u32 gStatuses3[MAX_BATTLERS_COUNT] = {0};
struct DisableStruct gDisableStructs[MAX_BATTLERS_COUNT] = {0};
u16 gPauseCounterBattle = 0;
u16 gPaydayMoney = 0;
u16 gRandomTurnNumber = 0;
u8 gBattleCommunication[BATTLE_COMMUNICATION_ENTRIES_COUNT] = {0};
u8 gBattleOutcome = 0;
struct ProtectStruct gProtectStructs[MAX_BATTLERS_COUNT] = {0};
struct SpecialStatus gSpecialStatuses[MAX_BATTLERS_COUNT] = {0};
u16 gBattleWeather = 0;
struct WishFutureKnock gWishFutureKnock = {0};
u16 gIntroSlideFlags = 0;
u8 gSentPokesToOpponent[2] = {0};
u16 gDynamicBasePower = 0;
u16 gExpShareExp = 0;
struct BattleEnigmaBerry gEnigmaBerries[MAX_BATTLERS_COUNT] = {0};
struct BattleScripting gBattleScripting = {0};
struct BattleStruct *gBattleStruct = NULL;
u8 *gLinkBattleSendBuffer = NULL;
u8 *gLinkBattleRecvBuffer = NULL;
struct BattleResources *gBattleResources = NULL;
u8 gActionSelectionCursor[MAX_BATTLERS_COUNT] = {0};
u8 gMoveSelectionCursor[MAX_BATTLERS_COUNT] = {0};
u8 gBattlerStatusSummaryTaskId[MAX_BATTLERS_COUNT] = {0};
u8 gBattlerInMenuId = 0;
bool8 gDoingBattleAnim = FALSE;
u32 gTransformedPersonalities[MAX_BATTLERS_COUNT] = {0};
struct BattleSpriteData *gBattleSpritesDataPtr = NULL;
struct MonSpritesGfx *gMonSpritesGfxPtr = NULL;
u16 gBattleMovePower = 0;
u16 gMoveToLearn = 0;
u8 gBattleMonForms[MAX_BATTLERS_COUNT] = {0};

void (*gPreBattleCallback1)(void) = NULL;
void (*gBattleMainFunc)(void) = NULL;
struct BattleResults gBattleResults = {0};
u8 gLeveledUpInBattle = 0;
void (*gBattlerControllerFuncs[MAX_BATTLERS_COUNT])(void) = {0};
u8 gHealthboxSpriteIds[MAX_BATTLERS_COUNT] = {0};
u8 gMultiUsePlayerCursor = 0;
u8 gNumberOfMovesToChoose = 0;
u8 gBattleControllerData[MAX_BATTLERS_COUNT] = {0};
