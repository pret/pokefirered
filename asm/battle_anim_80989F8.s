...
_08098A1C:
	ldr r1, _08098A60 @ =gUnknown_202063C
	lsls r0, r2, 4
	adds r0, r2
	lsls r0, 2
	adds r0, r1
...
_08098A58:
	...
	bx r0
	.align 2, 0
_08098A60: .4byte gUnknown_202063C
...
sub_8098A6C: @ 8098A6C
	...
	cmp r5, 0
	bne _08098B12
	ldr r2, _08098AAC @ =gUnknown_202063C
	movs r6, 0x8
	ldrsh r1, [r3, r6]
	lsls r0, r1, 4
	adds r0, r1
...
_08098AAC: .4byte gUnknown_202063C
_08098AB0:
	strh r5, [r1, 0x24]
_08098AB2:
	lsls r2, r4, 2
...
_08098BB4:
	ldr r1, _08098BF8 @ =gUnknown_202063C
	lsls r0, r3, 4
	adds r0, r3
	lsls r0, 2
	adds r0, r1
...
_08098BF2:
	...
	bx r0
	.align 2, 0
_08098BF8: .4byte gUnknown_202063C
...
sub_8098C08: @ 8098C08
	...
	cmp r0, 0
	bne _08098CC0
	ldr r2, _08098C50 @ =gUnknown_202063C
	movs r7, 0x8
	ldrsh r1, [r3, r7]
	lsls r0, r1, 4
	adds r0, r1
...
_08098C50: .4byte gUnknown_202063C
_08098C54:
	strh r5, [r4, 0x24]
_08098C56:
	lsls r3, r6, 2
...
_08098CF4:
	ldr r0, _08098D48 @ =gUnknown_202063C
	lsls r1, r3, 4
	adds r1, r3
	lsls r1, 2
	adds r1, r0
...
_08098D42:
	...
	bx r0
	.align 2, 0
_08098D48: .4byte gUnknown_202063C
...
_08098D72:
	...
	cmp r0, 0
	beq _08098DB4
	ldr r2, _08098DB0 @ =gUnknown_202063C
	movs r0, 0x8
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08098DB0: .4byte gUnknown_202063C
_08098DB4:
	ldr r3, _08098E40 @ =gUnknown_202063C
	movs r0, 0x8
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08098DDE:
	...
	b _08098E7C
	.align 2, 0
_08098E40: .4byte gUnknown_202063C
_08098E44:
	movs r6, 0x8
	ldrsh r0, [r4, r6]
	lsls r2, r0, 4
...
_08098EE4: .4byte gUnknown_202063C
...
sub_8098EF0: @ 8098EF0
	...
	asrs r1, 16
	mov r12, r2
	ldr r7, _08098F80 @ =gUnknown_202063C
	cmp r0, r1
	bne _08098F42
	movs r0, 0
	strh r0, [r3, 0x18]
...
_08098F80: .4byte gUnknown_202063C
...
_08099078: .4byte gUnknown_202063C
...
_080991DC:
	...
	movs r3, 0
	strh r0, [r6, 0x2E]
	ldr r0, _08099248 @ =gUnknown_202063C
	lsls r4, r7, 4
	adds r4, r7
	lsls r4, 2
	adds r4, r0
...
_08099248: .4byte gUnknown_202063C
_0809924C:
	cmp r0, 0x2
	bne _08099252
	strh r3, [r6, 0x30]
...
sub_8099270: @ 8099270
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _080992AC @ =gUnknown_202063C
	adds r3, r1, r0
	ldrh r0, [r2, 0x2E]
	movs r6, 0x2E
	ldrsh r1, [r2, r6]
...
_08099328:
	...
	movs r4, 0
	strh r0, [r5, 0x2E]
	ldr r0, _08099388 @ =gUnknown_202063C
	lsls r1, r6, 4
	adds r1, r6
	lsls r1, 2
	adds r1, r0
...
_080993E8:
	...
	ldrh r0, [r5, 0x8]
	strh r0, [r6, 0x2E]
	ldr r0, _08099448 @ =gUnknown_202063C
	lsls r4, r7, 4
	adds r4, r7
	lsls r4, 2
	adds r4, r0
...
sub_809946C: @ 809946C
	push {r4,lr}
	ldr r4, _08099498 @ =gUnknown_202063C
	movs r1, 0x38
	ldrsh r2, [r0, r1]
	lsls r1, r2, 4
	adds r1, r2
	...
	bx r0
	.align 2, 0
_08099498: .4byte gUnknown_202063C
...
sub_8099530: @ 8099530
	...
	adds r0, r2
	strh r0, [r5, 0x1E]
	ldr r2, _0809958C @ =gUnknown_202063C
	lsls r4, r1, 4
	adds r4, r1
	lsls r4, 2
	adds r4, r2
...
_0809958C: .4byte gUnknown_202063C
...
_080995BC:
	...
	adds r2, r1
	strh r2, [r4, 0x20]
	ldr r3, _080995F8 @ =gUnknown_202063C
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r1, r3
...
_080995F0:
	...
	bx r0
	.align 2, 0
_080995F8: .4byte gUnknown_202063C
...
sub_80996B8: @ 80996B8
	...
	adds r1, r0
	ldrb r2, [r1, 0x8]
	ldr r3, _08099700 @ =gUnknown_202063C
	lsls r0, r2, 4
	adds r0, r2
	lsls r0, 2
	adds r0, r3
...
_08099700: .4byte gUnknown_202063C
...
sub_8099788: @ 8099788
	...
	cmp r0, 0
	bne _080997E0
	ldr r0, _080997DC @ =gUnknown_202063C
	lsls r2, r7, 4
	adds r1, r2, r7
	lsls r1, 2
	adds r1, r0
...
_080997E0:
	...
	cmp r0, 0
	bne _08099808
	ldr r1, _08099804 @ =gUnknown_202063C
	lsls r2, r7, 4
	adds r0, r2, r7
	lsls r0, 2
	adds r3, r0, r1
	...
	b _08099822
	.align 2, 0
_08099804: .4byte gUnknown_202063C
_08099808:
	ldr r1, _080998A8 @ =gUnknown_202063C
	lsls r2, r7, 4
	adds r0, r2, r7
	lsls r0, 2
	adds r3, r0, r1
...
_0809989C:
	...
	bx r0
	.align 2, 0
_080998A8: .4byte gUnknown_202063C
...
_08099C3A:
	...
	lsrs r0, 24
	strh r0, [r4, 0x16]
	ldr r2, _08099CB0 @ =gUnknown_202063C
	movs r0, 0x16
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08099CB0: .4byte gUnknown_202063C
...
sub_8099CB8: @ 8099CB8
	...
	cmp r1, 0
	beq _08099D14
	ldr r2, _08099D10 @ =gUnknown_202063C
	movs r0, 0x16
	ldrsh r1, [r3, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08099D10: .4byte gUnknown_202063C
_08099D14:
	ldr r2, _08099D50 @ =gUnknown_202063C
	movs r0, 0x16
	ldrsh r1, [r3, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08099D2A:
	...
	b _08099D64
	.align 2, 0
_08099D50: .4byte gUnknown_202063C
_08099D54:
	ldr r2, _08099D9C @ =gUnknown_202063C
	movs r0, 0x16
	ldrsh r1, [r3, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_08099D96:
	...
	bx r0
	.align 2, 0
_08099D9C: .4byte gUnknown_202063C
