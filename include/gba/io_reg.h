...
// MOSAIC
#define MOSAIC_BG_HSIZE_MASK  0x000F
#define MOSAIC_BG_HSIZE_SHIFT      0

#define MOSAIC_BG_VSIZE_MASK  0x00F0
#define MOSAIC_BG_VSIZE_SHIFT      4

#define MOSAIC_OBJ_HSIZE_MASK 0x0F00
#define MOSAIC_OBJ_HSIZE_SHIFT     8

#define MOSAIC_OBJ_VSIZE_MASK 0xF000
#define MOSAIC_OBJ_VSIZE_SHIFT    12
