    ...
    while (*src != EOS)
    {
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_PARTNER_CLASS:
                toCpy = gTrainerClasses[TRAINER_CLASS_PKMN_TRAINER_1].name; // toCpy = gTrainerClasses[GetFrontierOpponentClass(gPartnerTrainerId)].name;
                break;
            ...
            case B_TXT_PARTNER_NAME_WITH_CLASS:
                toCpy = textStart;
                classString = gTrainerClasses[TRAINER_CLASS_PKMN_TRAINER_1].name; // classString = gTrainerClasses[GetFrontierOpponentClass(gPartnerTrainerId)].name;
                while (classString[classLength] != EOS)
                {
                    textStart[classLength] = classString[classLength];
                    classLength++;
            ...
            case B_TXT_ATK_TRAINER_CLASS:
                ...
                case B_POSITION_PLAYER_RIGHT:
                    ...
                    if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
                        toCpy = gTrainerClasses[TRAINER_CLASS_PKMN_TRAINER_1].name;
                    break;
                case B_POSITION_OPPONENT_LEFT:
                    toCpy = BattleStringGetOpponentClassByTrainerId(TRAINER_BATTLE_PARAM.opponentA);
                    break;
            ...
            case B_TXT_ATK_TRAINER_NAME_WITH_CLASS:
                ...
                else
                {
                    ...
                    case B_POSITION_PLAYER_RIGHT:
                        ...
                        if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
                            classString = gTrainerClasses[TRAINER_CLASS_PKMN_TRAINER_1].name;
                        break;
                    case B_POSITION_OPPONENT_LEFT:
                        classString = BattleStringGetOpponentClassByTrainerId(TRAINER_BATTLE_PARAM.opponentA);
                        break;
