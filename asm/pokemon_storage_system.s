...
_0808BA56:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_808BA18

	thumb_func_start sub_808BA5C
sub_808BA5C: @ 808BA5C
	push {r4-r6,lr}
	adds r5, r2, 0
	adds r6, r3, 0
...
_0808BA9C: .4byte gUnknown_3005010
	thumb_func_end sub_808BA5C

	thumb_func_start sub_808BAA0
sub_808BAA0: @ 808BAA0
	push {lr}
	adds r3, r0, 0
	adds r2, r1, 0
...
_0808BABC: .4byte gUnknown_3005010
	thumb_func_end sub_808BAA0

	thumb_func_start sub_808BAC0
sub_808BAC0: @ 808BAC0
	push {r4,r5,lr}
	adds r4, r0, 0
	adds r5, r1, 0
...
_0808BAE0: .4byte gUnknown_3005010
	thumb_func_end sub_808BAC0

	thumb_func_start sub_808BAE4
sub_808BAE4: @ 808BAE4
	push {r4,r5,lr}
	adds r5, r2, 0
	lsls r0, 24
...
_0808BB24:
	...
	pop {r0}
	bx r0
	thumb_func_end sub_808BAE4

	thumb_func_start sub_808BB2C
sub_808BB2C: @ 808BB2C
	push {r4,r5,lr}
	adds r5, r2, 0
	lsls r0, 24
...
_0808BB68: .4byte gUnknown_3005010
	thumb_func_end sub_808BB2C

	thumb_func_start sub_808BB6C
sub_808BB6C: @ 808BB6C
	push {r4-r6,lr}
	adds r5, r2, 0
	adds r6, r3, 0
...
_0808BBAE:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_808BB6C

	thumb_func_start sub_808BBB4
sub_808BBB4: @ 808BBB4
	push {r4,r5,lr}
	adds r5, r2, 0
	lsls r0, 24
...
_0808C0F4:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_808C0D4

	thumb_func_start sub_808C108
sub_808C108: @ 808C108
	push {r4,r5,lr}
	lsls r0, 24
	lsrs r5, r0, 24
...
_0808C134:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_808C108

	thumb_func_start sub_808C13C
sub_808C13C: @ 808C13C
	push {r4-r6,lr}
	movs r5, 0
	movs r6, 0
...
_0808C180: .4byte gUnknown_2024284
	thumb_func_end sub_808C13C

	thumb_func_start sub_808C184
sub_808C184: @ 808C184
	push {r4-r7,lr}
	lsls r0, 24
	movs r5, 0
...
_0808C1DC: .4byte gUnknown_2024284
	thumb_func_end sub_808C184

	thumb_func_start sub_808C1E0
sub_808C1E0: @ 808C1E0
	push {lr}
...
_0808C1F4: .4byte gUnknown_20370C0
	thumb_func_end sub_808C1E0

	thumb_func_start sub_808C1F8
sub_808C1F8: @ 808C1F8
	push {r4,r5,lr}
	movs r4, 0
	movs r5, 0
...
_0808C22C: .4byte gUnknown_2024284
	thumb_func_end sub_808C1F8

	thumb_func_start sub_808C230
sub_808C230: @ 808C230
	push {r4,r5,lr}
	adds r5, r0, 0
	lsls r4, r2, 16
...
_0808C6A4: .4byte gUnknown_2037AB8
	thumb_func_end sub_808C39C

	thumb_func_start sub_808C6A8
sub_808C6A8: @ 808C6A8
	push {lr}
	ldr r0, _0808C6D0 @ =sub_808C39C
	movs r1, 0x50
	bl sub_807741C
	lsls r0, 24
	lsrs r0, 24
...
sub_808C9C4: @ 808C9C4
	...
	strh r1, [r0]
	str r4, [sp, 0x20]
	ldr r0, _0808CB7C @ =gUnknown_8231CF0
	str r0, [sp, 0x24]
	str r1, [sp, 0x28]
	ldr r0, _0808CB80 @ =gUnknown_8231CFC
	str r0, [sp, 0x2C]
	ldr r0, _0808CB84 @ =nullsub_8
	str r0, [sp, 0x30]
	add r0, sp, 0x4
	mov r1, r8
	movs r2, 0x18
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0808CB94 @ =gUnknown_202063C
	adds r0, r1
	str r0, [r3]
	ldrb r2, [r4, 0x1]
	movs r1, 0x3F
...
_0808CB7C: .4byte gUnknown_8231CF0
_0808CB80: .4byte gUnknown_8231CFC
_0808CB84: .4byte nullsub_8
_0808CB88: .4byte gUnknown_83CDA94
_0808CB8C: .4byte gUnknown_20397AC
_0808CB90: .4byte 0x00000242
_0808CB94: .4byte gUnknown_202063C
...
_0808CE54: .4byte sub_808D020
_0808CE58: .4byte gUnknown_20397B8
_0808CE5C: .4byte sub_808CDC4
...
_0808CEC0: .4byte sub_808D020
_0808CEC4: .4byte sub_808CDC4
...
_0808D01C: .4byte gUnknown_20397B0
	thumb_func_end sub_808CFF8

	thumb_func_start sub_808D020
sub_808D020: @ 808D020
	push {lr}
	sub sp, 0x4
...
_0808D43C:
	movs r0, 0x5
	bl sub_80722CC
	ldr r0, _0808D44C @ =sub_808E744
	bl sub_808CFF8
	b _0808D7B2
	.align 2, 0
_0808D44C: .4byte sub_808E744
_0808D450:
...
_0808F17A:
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _0808F1CC @ =gUnknown_202063C
	adds r1, r0
	str r1, [r2]
	adds r0, r4, 0x1
	lsls r0, 16
...
_0808F1CC: .4byte gUnknown_202063C
...
_0808F36C:
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0808F3A4 @ =gUnknown_202063C
	adds r0, r1
	str r0, [r3]
	lsls r0, r4, 4
	movs r1, 0x80
...
_0808F3A4: .4byte gUnknown_202063C
...
_08090338:
	...
	cmp r0, 0xB6
	bls _08090354
	ldr r0, _08090358 @ =nullsub_8
	str r0, [r2, 0x1C]
_08090354:
	pop {r0}
	bx r0
	.align 2, 0
_08090358: .4byte nullsub_8
...
sub_80912E0: @ 80912E0
	...
	cmp r2, 0x40
	beq _080913AC
	ldr r1, _080913A0 @ =gUnknown_202063C
	lsls r0, r2, 4
	adds r0, r2
	lsls r0, 2
	adds r0, r1
...
_080913A0: .4byte gUnknown_202063C
...
_08091BBC:
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _08091C44 @ =gUnknown_202063C
	adds r0, r1
	str r0, [r2]
	lsls r1, r4, 24
	lsrs r1, 24
...
_08091C44: .4byte gUnknown_202063C
...
_08091D82:
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _08091E28 @ =gUnknown_202063C
	adds r1, r0
	str r1, [r2]
	mov r0, r8
	lsls r4, r0, 1
...
_08091E28: .4byte gUnknown_202063C
...
_08091E98:
	...
	cmp r0, r1
	bne _08091EB0
	ldr r0, _08091EB4 @ =nullsub_8
	str r0, [r2, 0x1C]
_08091EB0:
	pop {r0}
	bx r0
	.align 2, 0
_08091EB4: .4byte nullsub_8
...
_08091F8A:
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _08092004 @ =gUnknown_202063C
	adds r4, r0, r1
	lsls r1, r5, 24
	lsrs r1, 24
	adds r0, r4, 0
...
_08092004: .4byte gUnknown_202063C
...
sub_809223C: @ 809223C
	...
	adds r4, r0
	lsls r4, 2
	ldr r5, _080922AC @ =gUnknown_202063C
	adds r6, r4, r5
	adds r0, r6, 0
	bl sub_800838C
	movs r0, 0x3
	...
	adds r5, 0x1C
	adds r4, r5
	ldr r0, _080922B0 @ =nullsub_8
	str r0, [r4]
	adds r0, r6, 0
	b _080922B6
	.align 2, 0
_080922A8: .4byte gUnknown_83D2BB4
_080922AC: .4byte gUnknown_202063C
_080922B0: .4byte nullsub_8
_080922B4:
	movs r0, 0
_080922B6:
	pop {r3}
...
sub_8094AD8: @ 8094AD8
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _08094BCC @ =gUnknown_202063C
	adds r1, r0
	str r1, [r3]
...
_08094BCC: .4byte gUnknown_202063C
...
_08094C00:
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _08094C60 @ =gUnknown_202063C
	adds r1, r0
	str r1, [r2]
	lsls r3, r4, 2
	ldrb r2, [r1, 0x5]
...
_08094C60: .4byte gUnknown_202063C
...
_08095B9C:
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _08095C7C @ =gUnknown_202063C
	adds r1, r0
	str r1, [r2]
	adds r1, 0x3E
	ldrb r0, [r1]
...
_08095C7C: .4byte gUnknown_202063C
