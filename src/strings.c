...
const u8 gText_Options[] = _("CONFIGURACIÓN");
const u8 gText_Team[] = _("");
...
#ifndef SRAM
const u8 gText_SaveFileCorrupted[] = _("Si tienes este cartucho, por favor no\ncompartas su contenido.");
#else
const u8 gText_SaveFileCorrupted[] = _("Si tienes este cartucho, por favor no\ncompartas su contenido.");
#endif
const u8 gText_SaveFileHasBeenDeleted[] = _("{COLOR RED}{SHADOW LIGHT_RED}LA PARTIDA HA SIDO ELIMINADA{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
#ifndef SRAM
...
const u8 gText_Boy[] = _("FEMENINO");
const u8 gText_Girl[] = _("MASCULINO");
const u8 gText_PokedexTableOfContents[] = _("POKéDEX   TABLA DE CONTENIDOS");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}SEL. {SELECT_BUTTON} ORDEN NUMÉRICO");
const u8 gText_Seen[] = _("VISTOS");
const u8 gText_Owned[] = _("CAPTURADOS");
...
const u8 gText_DexCategory_GrasslandPkmn[] = _("PRADERA");
const u8 gText_DexCategory_ForestPkmn[] = _("BOSQUE");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("AGUA DULCE");
const u8 gText_DexCategory_SeaPkmn[] = _("AGUA SALADA");
const u8 gText_DexCategory_CavePkmn[] = _("CUEVA");
const u8 gText_DexCategory_MountainPkmn[] = _("MONTAÑA");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("CAMPO");
const u8 gText_DexCategory_UrbanPkmn[] = _("CIUDAD");
const u8 gText_DexCategory_RarePkmn[] = _("RARO");
...
const u8 gText_ClosePokedex[] = _("SALIR DE POKéDEX");
...
const u8 gText_GoBackToThePreviousMenu[] = _("Volver al menú anterior.");
...
const u8 gText_PkmnNeedsToReplaceMove[] = _("{SHADOW DYNAMIC_COLOR4}{STR_VAR_1}{SHADOW LIGHT_GRAY} quiere aprender\nel movimiento {SHADOW DYNAMIC_COLOR4}{STR_VAR_2}{SHADOW LIGHT_GRAY}.\pSin embargo, {SHADOW DYNAMIC_COLOR4}{STR_VAR_1}{SHADOW LIGHT_GRAY}\nya conoce cuatro movimientos.\p¿Quieres olvidar un movimiento y\nreemplazarlo por {SHADOW DYNAMIC_COLOR4}{STR_VAR_2}{SHADOW LIGHT_GRAY}?");
const u8 gText_StopLearningMove2[] = _("¿Dejar de intentar enseñar\n{SHADOW DYNAMIC_COLOR4}{STR_VAR_2}{SHADOW LIGHT_GRAY}?");
const u8 gText_MoveNotLearned[] = _("{SHADOW DYNAMIC_COLOR4}{STR_VAR_1}{SHADOW LIGHT_GRAY} no aprendió el movimiento\n{SHADOW DYNAMIC_COLOR4}{STR_VAR_2}{SHADOW LIGHT_GRAY}.{PAUSE_UNTIL_PRESS}");
const u8 gText_WhichMoveToForget[] = _("¿Qué movimiento debería olvidar?{PAUSE_UNTIL_PRESS}");
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 0x0F}2, and{PAUSE 0x0F}... {PAUSE 0x0F}... {PAUSE 0x0F}... {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}¡Poof!\p{STR_VAR_1} olvidó como\nusar {STR_VAR_2}.\pY...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon[] = _("¿A qué {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} se lo quieres enseñar?");
...
const u8 gText_ChoosePokemonConfirm[] = _("ELIGE {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} Y CONFIRMA.");
...
const u8 gText_ItemStorage[] = _("DEPÓSITO");
const u8 gText_Mailbox[] = _("BUZÓN");
const u8 gText_DepositItem2[] = _("GUARDAR OBJETO");
const u8 gText_WithdrawItem2[] = _("RETIRAR OBJETO");
const u8 gText_TossItem[] = _("どうぐを すてる");
const u8 gText_StoreItemsInThePC[] = _("Guardar objetos en la {SHADOW DYNAMIC_COLOR4}PC{SHADOW LIGHT_GRAY}.");
const u8 gText_TakeOutItemsFromThePC[] = _("Sacar objetos de la {SHADOW DYNAMIC_COLOR4}PC{SHADOW LIGHT_GRAY}.");
...
const u8 gText_TheresNoMailHere[] = _("No hay ningún {SHADOW DYNAMIC_COLOR4}CORREO{SHADOW LIGHT_GRAY} aquí.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Psn[] = _("ENVE.");
const u8 gText_Par[] = _("PARA.");
const u8 gText_Slp[] = _("DORM.");
const u8 gText_Brn[] = _("QUEM.");
const u8 gText_Frz[] = _("CONG.");
...
const u8 gText_JoinGroup[] = _("UNIRSE GRUPO");
...
const u8 gText_WithdrawMonDescription[] = _("Puedes retirar un {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} si tienes\nalguno en una {SHADOW DYNAMIC_COLOR4}CAJA{SHADOW LIGHT_GRAY}.");
const u8 gText_DepositMonDescription[] = _("Puedes depositar a los {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} de\ntu equipo en cualquier {SHADOW DYNAMIC_COLOR4}CAJA{SHADOW LIGHT_GRAY}.");
const u8 gText_MoveMonDescription[] = _("Puedes mover a los {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} que\nestén guardados en cualquier {SHADOW DYNAMIC_COLOR4}CAJA{SHADOW LIGHT_GRAY}.");
const u8 gText_MoveItemsDescription[] = _("Puedes mover los objetos que tengan\nlos {SHADOW DYNAMIC_COLOR4}POKéMON{SHADOW LIGHT_GRAY} en una {SHADOW DYNAMIC_COLOR4}CAJA{SHADOW LIGHT_GRAY} o en tu equipo.");
const u8 gText_SeeYaDescription[] = _("¡Hasta luego!");
...
const u8 gText_YourName[] = _("TU NOMBRE ES...");
const u8 gText_BoxName[] = _("NOMBRE DE LA CAJA...");
const u8 gText_PkmnsNickname[] = _("APODO PARA ");
const u8 gText_Ellipsis[] = _("...");
const u8 gText_RivalsName[] = _("SU NOMBRE ES...");
const u8 gText_PkmnsQuestion[] = _("?");
const u8 gText_MoveOkBack[] = _(" {DPAD_ANY}MOVER {A_BUTTON}SEL. {B_BUTTON}ATRÁS");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("INFORMACIÓN");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("ESTADÍSTICAS");
const u8 gText_PokeSum_PageName_KnownMoves[] = _("MOVIMIENTOS");
const u8 gText_PokeSum_NoData[] = _("Sin datos.");
const u8 gText_PokeSum_ExpPoints[] = _("");
const u8 gText_PokeSum_NextLv[] = _("");
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PÁG. {B_BUTTON}SALIR");
...
const u8 gText_PlayerScurriedToCenter[] = _("¡RECUPÉRATE EN EL CENTRO POKéMON\nY SIGUE EN ADELANTE CON TU AVENTURA!\p");
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} CORRIÓ DE VUELTA A CASA PARA\nCURAR A SUS AGOTADOS POKÉMON Y EVITAR\nQUE SUFRIERAN MÁS DAÑO...\p");
...
const u8 gText_10P30P50P50P[] = _("10P     30P     50P     50P");
...
const u8 gText_Trade_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Comunicación en espera…\nPor favor, espera.");
...
const u8 gText_WaitingForFriendToFinish[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Esperando a tu amigo para terminar...");
...
//Dexnav
const u8 gText_DexNavInstructions[] = _(" {DPAD_ANY}ELEGIR {A_BUTTON}SEL. {B_BUTTON}SALIR");
const u8 gText_DexNavWater[] = _("AGUA");
const u8 gText_DexNavLand[] = _("HIERBA");
const u8 gText_GotAway[] = _("¡{SHADOW DYNAMIC_COLOR4}{STR_VAR_1}{SHADOW LIGHT_GRAY} ha huido!");
const u8 gText_LostSignal[] = _("No hay respuesta.\n¡La señal se perdió!");
...
const u8 gText_NotFoundNearby[] = _("No veo rastros de {SHADOW DYNAMIC_COLOR4}{STR_VAR_1}{SHADOW LIGHT_GRAY}.\nTal vez esté en otro lugar.");
...
const u8 gText_DexNav_CaptureToSee[] = _("");
const u8 gText_DexNav_ChooseMon[] = _(" ELIGE UN POKéMON");
const u8 gText_DexNav_Invalid[] = _("NO SE PUEDE BUSCAR");
