...
const u16 gMetatiles_PowerPlantFlash[] = INCBIN_U16("data/tilesets/primary/power_plant_flash/metatiles.bin");
const u32 gMetatileAttributes_PowerPlantFlash[] = INCBIN_U32("data/tilesets/primary/power_plant_flash/metatile_attributes.bin");

const u16 gMetatiles_PewterGymInterior[] = INCBIN_U16("data/tilesets/primary/building/metatiles.bin");
const u32 gMetatileAttributes_PewterGymInterior[] = INCBIN_U32("data/tilesets/primary/building/metatile_attributes.bin");
