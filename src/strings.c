...
const u8 gText_TMShop_No[] = _("{NO}{CLEAR 0x01}");
...
const u8 gText_ClearAllSaveDataAreas[] = _("Clear all save data areas?");
const u8 gText_ClearingDataPleaseWait[] = _("Clearing data‥\nPlease wait.");
...
const u8 gText_DelAll_Cancel_OK[] = _("DEL. ALL{CLEAR_TO 0x57}CANCEL{CLEAR_TO 0xA4}OK");
