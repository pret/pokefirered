...
#if P_FAMILY_TOGEPI
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_NORMAL : TYPE_NORMAL)
...
#define WOOPER_MISC_INFO                                                        \
    ...
    [SPECIES_MURKROW] =
    {
        ...
        LEARNSETS(Murkrow),
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_HONCHKROW}),
    },
...
#define SNEASEL_MISC_INFO                                   \
    ...
    [SPECIES_SNEASEL_HISUIAN] =
    {
        ...
        .isHisuianForm = TRUE,
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_SNEASLER}),
    },
