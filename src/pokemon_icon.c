...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_MIME_JR]      = gMonIcon_Cleffa,
    [SPECIES_AMBIPOM]   = gMonIcon_Igglybuff,
    ...
    [SPECIES_WEAVILE]       = gMonIcon_UnownA,
    [SPECIES_GLISCOR]   = gMonIcon_Wobbuffet,
    ...
    [SPECIES_PROBOPASS]    = gMonIcon_Smeargle,
    ...
    [SPECIES_ROSERADE]      = gMonIcon_Raikou,
    [SPECIES_TANGROWTH]       = gMonIcon_Entei,
    [SPECIES_YANMEGA]     = gMonIcon_Suicune,
    [SPECIES_LARVITAR]    = gMonIcon_Larvitar,
    [SPECIES_PUPITAR]     = gMonIcon_Pupitar,
    [SPECIES_TYRANITAR]   = gMonIcon_Tyranitar,
    [SPECIES_MISMAGIUS]       = gMonIcon_Lugia,
    [SPECIES_HONCHKROW]       = gMonIcon_HoOh,
    [SPECIES_FROSLASS]      = gMonIcon_Celebi,
    ...
    [SPECIES_ELECTIVIRE]    = gMonIcon_Shedinja,
    ...
    [SPECIES_HAPPINY]     = gMonIcon_Luvdisc,
    ...
    [SPECIES_TOGEKISS]      = gMonIcon_Wynaut,
    ...
    [SPECIES_MAGMORTAR]    = gMonIcon_Castform,
    ...
    [SPECIES_MUNCHLAX]    = gMonIcon_Regirock,
    [SPECIES_LICKILICKY]      = gMonIcon_Regice,
    [SPECIES_MAGNEZONE]   = gMonIcon_Registeel,
    [SPECIES_PORYGON_Z]      = gMonIcon_Kyogre,
    [SPECIES_GALLADE]     = gMonIcon_Groudon,
    [SPECIES_DUSKNOIR]    = gMonIcon_Rayquaza,
    [SPECIES_RHYPERIOR]      = gMonIcon_Latias,
    [SPECIES_MAMOSWINE]      = gMonIcon_Latios,
    [SPECIES_LEAFEON]     = gMonIcon_Jirachi,
    [SPECIES_GLACEON]      = gMonIcon_Deoxys,
...
u16 MailSpeciesToIconSpecies(u16 species)
{
    ...
    if (MailSpeciesToSpecies(species, &value) == SPECIES_UNOWN_B)
    {
        if (value == 0)
            value += SPECIES_WEAVILE;
        else
