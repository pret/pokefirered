...
static const u8 sText_Trainer1RecallPkmn1[] = _("¡{B_OPPONENT_MON1_NAME}, REGRESA!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer1RecallPkmn2[] = _("¡{B_OPPONENT_MON2_NAME}, REGRESA!");
...
static const u8 sText_PkmnGainedEXP[] = _("¡{B_BUFF1} GANÓ{B_BUFF2} {B_BUFF3} PUNTOS\nDE EXPERIENCIA!\p");
...
static const u8 sText_TryToLearnMove2[] = _("PERO, {B_BUFF1} NO PUEDE APRENDER\nMÁS DE CUATRO MOVMIENTOS.\p");
static const u8 sText_TryToLearnMove3[] = _("¿QUIERES REEMPLAZAR UN MOVIMIENTO\nPOR {B_BUFF2}?");
...
static const u8 sText_PlayerWhiteout[] = _("¡{B_PLAYER_NAME} SE QUEDÓ SIN POKéMON!\p");
static const u8 sText_PlayerPanicked[] = _("{B_PLAYER_NAME} ENTRÓ EN PÁNICO Y PERDIÓ\n¥{B_BUFF1}...\p...\p¡{B_PLAYER_NAME} ESTÁ FUERA DE COMBATE!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("¡{B_PLAYER_NAME} SE QUEDÓ SIN POKéMON!\p¡PERDISTE CONTRA\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("{B_PLAYER_NAME} PAGÓ ¥{B_BUFF1} COMO\nPREMIO\p...\p¡{B_PLAYER_NAME} ESTÁ FUERA DE COMBATE!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PkmnHurtByBurn[] = _("¡{B_ATK_NAME_WITH_PREFIX} RECIBE DAÑO\nDE LA QUEMADURA!");
...
static const u8 sText_PkmnIsParalyzed[] = _("¡{B_ATK_NAME_WITH_PREFIX} está paralizada!\n¡No se puede mover!");
...
static const u8 sText_PkmnSqueezedByBind[] = _("¡{B_DEF_NAME_WITH_PREFIX} FUE APRETADO POR LA\nATADURA DE {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("¡{B_DEF_NAME_WITH_PREFIX} está atrapado\nen el vórtice!");
...
static const u8 sText_PkmnBuffetedBySandstorm[] = _("¡{B_ATK_NAME_WITH_PREFIX} es dañada por\nla tormenta de arena!");
static const u8 sText_PkmnPeltedByHail[] = _("¡{B_ATK_NAME_WITH_PREFIX} es dañada por\nel GRANIZO!");
...
static const u8 sText_PkmnFatigueConfusion[] = _("¡{B_ATK_NAME_WITH_PREFIX} está confundida\ndebido a la fatiga!");
...
static const u8 sText_PkmnLockedInNightmare[] = _("¡{B_ATK_NAME_WITH_PREFIX} está atrapada\nen una PESADILLA!");
static const u8 sText_PkmnLaidCurse[] = _("¡{B_ATK_NAME_WITH_PREFIX} CORTA SUS PROPIOS PS\nY MALDICE A {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("¡{B_ATK_NAME_WITH_PREFIX} es afectada\npor la MALDICIÓN!");
...
static const u8 sText_PkmnSubjectedToTorment[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue sometido\na un TORMENTO!");
...
static const u8 sText_PkmnReadyToHelp[] = _("¡{B_ATK_NAME_WITH_PREFIX} está lista para\nayudar {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_NoRunningFromTrainers[] = _("¡NO HAY ESCAPE DE BATALLAS ENTRE\nENTRENADORES!\p");
...
static const u8 sText_WildPkmnAppeared[] = _("¡{B_OPPONENT_MON1_NAME} SALVAJE HA APARECIDO!\p");
static const u8 sText_WildPkmnAppeared2[] = _("¡{B_OPPONENT_MON1_NAME} SALVAJE HA APARECIDO!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("¡{B_OPPONENT_MON1_NAME} SALVAJE HA APARECIDO!{PAUSE 127}");
...
static const u8 sText_Trainer1WantsToBattle[] = _("¡{B_TRAINER1_CLASS} {B_TRAINER1_NAME} TE DESAFIA!\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("¡{B_LINK_OPPONENT1_NAME} TE DESAFIA!");
...
static const u8 sText_FoePkmnPrefix2[] = _("BBB");
static const u8 sText_AllyPkmnPrefix[] = _("aliado");
static const u8 sText_FoePkmnPrefix3[] = _("CCC");
static const u8 sText_AllyPkmnPrefix2[] = _("aliado");
static const u8 sText_FoePkmnPrefix4[] = _("El rival");
...
static const u8 sText_PlayerUsedItem[] = _("¡{B_PLAYER_NAME} USÓ {B_LAST_ITEM}!");
static const u8 sText_OldManUsedItem[] = _("¡EL PROF. OAK USÓ {B_LAST_ITEM}!");
static const u8 sText_PokedudeUsedItem[] = _("¡EL POKé INSTRUCTOR USÓ {B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("¡{B_TRAINER1_CLASS} {B_TRAINER1_NAME} USÓ {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("¡LA BALL FUE BLOQUEADA!");
static const u8 sText_DontBeAThief[] = _("¡NO HAGAS TRAMPA!");
...
static const u8 sText_ItAppearedCaught[] = _("¡AWWW!\n¡PARECÍA ESTAR CAPTURADO!");
...
static const u8 sText_GiveNicknameCaptured[] = _("¿LE DARÁS UNA APODO AL\n{B_OPPONENT_MON1_NAME} CAPTURADO?");
...
const u8 gText_WhatWillPkmnDo[] = _("¿QUÉ DEBERÍA\nHACER {B_ACTIVE_NAME_WITH_PREFIX}?");
const u8 gText_WhatWillPlayerThrow[] = _("What will {B_PLAYER_NAME}\nthrow?");
const u8 gText_WhatWillOldManDo[] = _("¿QUÉ HARÁ EK\nPROF. OAK?");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Link standby…");
const u8 gText_BattleMenu[] = _("{PALETTE 4}{COLOR_HIGHLIGHT_SHADOW 13 14 15}LUCHAR{CLEAR_TO 56}MOCHILA\nPOKéMON{CLEAR_TO 56}HUIR");
