...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER - BATTLESTRINGS_TABLE_START]        = sText_GotchaPkmnCaught,
    [STRINGID_GOTCHAPKMNCAUGHT_OLDMANORDUDE - BATTLESTRINGS_TABLE_START] = sText_GotchaPkmnCaught2,
