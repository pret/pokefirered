...
static void PrintTotalRecord(struct LinkBattleRecords * records)
{
    ...
    AddTextPrinterParameterized4(0, FONT_SMALL, 12, 24, 0, 2, sTextColor, 0, gStringVar4);
}
...
static void PrintOpponentBattleRecord(struct LinkBattleRecord * record, u8 y)
{
    ...
    {
        AddTextPrinterParameterized4(0, FONT_SMALL, 0, y, 0, 2, sTextColor, 0, gString_BattleRecords_7Dashes);
        for (i = 0; i < 3; i++)
        {
            if (i == 0)
                x = 0x54;
                ...
                x = 0xB4;
            AddTextPrinterParameterized4(0, FONT_SMALL, x, y, 0, 2, sTextColor, 0, gString_BattleRecords_4Dashes);
        }
    }
    else
    {
        for (i = 0; i < 4; i++)
        {
            ...
            AddTextPrinterParameterized4(0, FONT_SMALL, x, y, 0, 2, sTextColor, 0, gStringVar1);
        }
    }
}
...
static void PrintBattleRecords(void)
{
    ...
    left = 0xD0 - GetStringWidth(FONT_SMALL, gStringVar4, -1);
    AddTextPrinterParameterized4(0, FONT_SMALL, left / 2, 4, 0, 2, sTextColor, 0, gStringVar4);
    PrintTotalRecord(&gSaveBlock2Ptr->linkBattleRecords);
    AddTextPrinterParameterized4(0, FONT_SMALL, 0x54, 0x30, 0, 2, sTextColor, 0, gString_BattleRecords_ColumnHeaders);
    for (i = 0; i < LINK_B_RECORDS_COUNT; i++)
