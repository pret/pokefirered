...
_0814AE2A:
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0814AEE4 @ =gUnknown_202063C
	adds r0, r1
	str r0, [r2]
...
_0814AEE4: .4byte gUnknown_202063C
...
sub_814AF0C: @ 814AF0C
	...
	adds r4, r6
	ldr r1, [r4]
	ldr r0, _0814AF6C @ =gUnknown_202063C
	subs r1, r0
	lsls r0, r1, 4
	subs r0, r1
	lsls r1, r0, 8
...
_0814AF6C: .4byte gUnknown_202063C
...
_0814AFCE:
	...
	orrs r0, r1
	strb r0, [r3]
	ldr r0, _0814AFE4 @ =nullsub_8
	str r0, [r2, 0x1C]
_0814AFDE:
	pop {r0}
	bx r0
	.align 2, 0
_0814AFE4: .4byte nullsub_8
...
sub_814B240: @ 814B240
	...
	cmp r2, 0x40
	beq _0814B280
	ldr r0, _0814B28C @ =gUnknown_202063C
	lsls r1, r2, 4
	adds r1, r2
	lsls r1, 2
	adds r1, r0
...
_0814B28C: .4byte gUnknown_202063C
...
_0814B29E:
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0814B344 @ =gUnknown_202063C
	adds r0, r1
	str r0, [r2]
	adds r5, 0x1
	adds r6, 0x14
...
_0814B344: .4byte gUnknown_202063C
