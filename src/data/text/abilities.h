...
// Generation 4 Ability Descriptions
static const u8 sMoldBreakerDescription[] = _("Attacks ignore abilities.");
static const u8 sTechnicianDescription[] = _("Powers up weak moves.");
static const u8 sAnticipationDescription[] = _("Senses the foe's danger.");
static const u8 sRivalryDescription[] = _("Powers up vs. same gender.");
...
static const u8 sFlowerGiftDescription[] = _("Ups stats in sunshine.");
static const u8 sStormDrainDescription[] = _("Draws water-type moves.");
static const u8 sAftermathDescription[] = _("Damages attacker on KO.");
static const u8 sUnburdenDescription[] = _("Boosts SPEED on item use.");
static const u8 sKlutzDescription[] = _("Prevents item use.");
static const u8 sFriskDescription[] = _("Checks foe's held item.");
static const u8 sSuperLuckDescription[] = _("Boosts critical-hit rate.");
static const u8 sHeatproofDescription[] = _("Halves fire-type damage.");
static const u8 sFilterDescription[] = _("Reduces super-effective hit.");
static const u8 sTangledFeetDescription[] = _("Ups evasion if confused.");
static const u8 sSteadfastDescription[] = _("Boosts SPEED if flinched.");
...
static const u8 sSolidRockDescription[] = _("Reduces super-effective hit.");
static const u8 sLeafGuardDescription[] = _("Prevents status in sun.");
...
static const u8 sIceBodyDescription[] = _("Restores HP in a hailstorm.");
...
static const u8 sDownloadDescription[] = _("Raises a stat based on foe.");
...
static const u8 sMultitypeDescription[] = _("Changes type with held Plate.");
static const u8 sSniperDescription[] = _("Powers up critical hits.");
static const u8 sDrySkinDescription[] = _("Heals in rain, hurt by sun.");
