...
static void CreateNidoranFSprite(u8 taskId)
{
    ...
    DecompressPicFromTable(&gMonFrontPicTable[SPECIES_UNOWN], OakSpeechNidoranFGetBuffer(0), SPECIES_UNOWN);
    LoadCompressedSpritePaletteUsingHeap(&gMonPaletteTable[SPECIES_UNOWN]);
    SetMultiuseSpriteTemplateToPokemon(SPECIES_UNOWN, 0);
