...
sub_809DB70: @ 809DB70
	push {r4,r5,lr}
	movs r3, 0
	ldr r4, _0809DBAC @ =gUnknown_202063C
	movs r5, 0x5
	negs r5, r5
_0809DB7A:
	lsls r0, r3, 4
...
sub_809E8B4: @ 809E8B4
	...
	movs r0, 0x1
	bl sub_809EA0C
	ldr r6, _0809E944 @ =gUnknown_202063C
	ldr r0, [r5]
	adds r0, r4
	ldrb r0, [r0]
	lsls r1, r0, 4
...
_0809E944: .4byte gUnknown_202063C
...
sub_809E948: @ 809E948
	...
	adds r1, r2
	lsls r1, 2
	ldr r2, _0809E99C @ =gUnknown_202063C
	adds r5, r1, r2
	lsrs r1, r0, 16
	mov r8, r1
	asrs r6, r0, 16
...
_0809E99C: .4byte gUnknown_202063C
...
sub_809E9CC: @ 809E9CC
	...
	adds r2, r3
	lsls r2, 2
	ldr r3, _0809E9F4 @ =gUnknown_202063C
	adds r2, r3
	ldrh r3, [r2, 0x2E]
	strh r3, [r0]
	ldrh r0, [r2, 0x30]
...
_0809E9F4: .4byte gUnknown_202063C
...
sub_809EA0C: @ 809EA0C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r5, _0809EA54 @ =gUnknown_202063C
	...
	bx r0
	.align 2, 0
_0809EA54: .4byte gUnknown_202063C
...
sub_809EA64: @ 809EA64
	push {r4,r5,lr}
	lsls r0, 24
	ldr r5, _0809EA9C @ =gUnknown_202063C
	...
	bx r0
	.align 2, 0
_0809EA9C: .4byte gUnknown_202063C
...
sub_809EAA8: @ 809EAA8
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0809EAD0 @ =gUnknown_202063C
	adds r0, r1
	movs r1, 0x1
	bl sub_800838C
	pop {r0}
...
_0809EAD0: .4byte gUnknown_202063C
	thumb_func_end sub_809EAA8

	thumb_func_start sub_809EAD4
sub_809EAD4: @ 809EAD4
	ldr r2, _0809EAF4 @ =gUnknown_202063C
	...
	bx lr
	.align 2, 0
_0809EAF4: .4byte gUnknown_202063C
...
sub_809EB5C: @ 809EB5C
	...
	adds r5, r0
	lsls r5, 2
	ldr r0, _0809EC0C @ =gUnknown_202063C
	mov r8, r0
	add r5, r8
...
_0809EC0C: .4byte gUnknown_202063C
...
sub_809EC20: @ 809EC20
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0809EC4C @ =gUnknown_202063C
	adds r0, r1
	movs r1, 0x2
	strh r1, [r0, 0x2E]
...
_0809EC4C: .4byte gUnknown_202063C
...
sub_809EC7C: @ 809EC7C
	...
	adds r5, r0
	lsls r5, 2
	ldr r1, _0809ECC4 @ =gUnknown_202063C
	adds r5, r1
	movs r2, 0x3C
	ldrsh r0, [r6, r2]
	lsls r4, r0, 4
	...
	bx r1
	.align 2, 0
_0809ECC4: .4byte gUnknown_202063C
...
sub_809ECD4: @ 809ECD4
	...
	adds r0, r1
	lsls r0, 2
	ldr r2, _0809ED40 @ =gUnknown_202063C
	adds r4, r0, r2
	movs r0, 0x3C
	ldrsh r1, [r3, r0]
	lsls r0, r1, 4
...
_0809ED38:
	...
	bx r1
	.align 2, 0
_0809ED40: .4byte gUnknown_202063C
...
sub_809ED48: @ 809ED48
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0809ED84 @ =gUnknown_202063C
	adds r2, r0, r1
	adds r3, r2, 0
	adds r3, 0x3E
	ldrb r1, [r3]
...
_0809ED7C:
	...
	bx r1
	.align 2, 0
_0809ED84: .4byte gUnknown_202063C
...
sub_809EDE8: @ 809EDE8
	...
	adds r4, r0
	lsls r4, 2
	ldr r6, _0809EE54 @ =gUnknown_202063C
	adds r4, r6
...
_0809EE54: .4byte gUnknown_202063C
...
sub_809EE60: @ 809EE60
	...
	lsls r0, 24
	lsrs r1, r0, 24
	ldr r3, _0809EF18 @ =gUnknown_202063C
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r3
...
_0809EF18: .4byte gUnknown_202063C
...
sub_809EF54: @ 809EF54
	...
	lsls r1, 24
	lsrs r1, 24
	ldr r2, _0809EFAC @ =gUnknown_202063C
	lsls r0, r1, 4
	adds r0, r1
	lsls r0, 2
	adds r0, r2
...
_0809EFA8: .4byte nullsub_8
_0809EFAC: .4byte gUnknown_202063C
...
sub_809EFB0: @ 809EFB0
	...
	adds r4, r0
	lsls r4, 2
	ldr r0, _0809EFE8 @ =gUnknown_202063C
	adds r4, r0
...
_0809EFE8: .4byte gUnknown_202063C
...
sub_809EFF0: @ 809EFF0
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _0809F048 @ =gUnknown_202063C
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r1, r2
...
_0809F040: .4byte nullsub_8
_0809F044: .4byte 0x00001e38
_0809F048: .4byte gUnknown_202063C
...
sub_809F04C: @ 809F04C
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _0809F0C8 @ =gUnknown_202063C
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r1, r2
...
_0809F0C0: .4byte nullsub_8
_0809F0C4: .4byte gUnknown_83E23BC
_0809F0C8: .4byte gUnknown_202063C
