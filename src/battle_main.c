...
const struct TrainerMoneyBall gTrainerMoneyAndBallTable[] =
{
    ...
    { CLASS_BIRD_KEEPER_2, 6, ITEM_GREAT_BALL },
    ...
    { CLASS_LASS_2, 4, ITEM_ULTRA_BALL },
    ...
    { CLASS_ENGINEER, 12, ITEM_GREAT_BALL },
    ...
    { CLASS_YOUNG_COUPLE_2, 7, ITEM_POKE_BALL },
    ...
    { CLASS_TRIATHLETE, 10, ITEM_GREAT_BALL },
    ...
    { CLASS_YOUNG_COUPLE, 8, ITEM_POKE_BALL },
    { CLASS_GUITARIST, 8, ITEM_GREAT_BALL },
