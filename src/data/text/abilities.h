...
static const u8 sGen4PlaceholderDescription[] = _("Gen 4 ability placeholder.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_ADAPTABILITY] = sGen4PlaceholderDescription,
    [ABILITY_AFTERMATH] = sGen4PlaceholderDescription,
    [ABILITY_ANGER_POINT] = sGen4PlaceholderDescription,
    [ABILITY_ANTICIPATION] = sGen4PlaceholderDescription,
    [ABILITY_BAD_DREAMS] = sGen4PlaceholderDescription,
    [ABILITY_DOWNLOAD] = sGen4PlaceholderDescription,
    [ABILITY_DRY_SKIN] = sGen4PlaceholderDescription,
    [ABILITY_FILTER] = sGen4PlaceholderDescription,
    [ABILITY_FLOWER_GIFT] = sGen4PlaceholderDescription,
    [ABILITY_FOREWARN] = sGen4PlaceholderDescription,
    [ABILITY_FRISK] = sGen4PlaceholderDescription,
    [ABILITY_GLUTTONY] = sGen4PlaceholderDescription,
    [ABILITY_HEATPROOF] = sGen4PlaceholderDescription,
    [ABILITY_HONEY_GATHER] = sGen4PlaceholderDescription,
    [ABILITY_HYDRATION] = sGen4PlaceholderDescription,
    [ABILITY_ICE_BODY] = sGen4PlaceholderDescription,
    [ABILITY_IRON_FIST] = sGen4PlaceholderDescription,
    [ABILITY_KLUTZ] = sGen4PlaceholderDescription,
    [ABILITY_LEAF_GUARD] = sGen4PlaceholderDescription,
    [ABILITY_MAGIC_GUARD] = sGen4PlaceholderDescription,
    [ABILITY_MOLD_BREAKER] = sGen4PlaceholderDescription,
    [ABILITY_MOTOR_DRIVE] = sGen4PlaceholderDescription,
    [ABILITY_MULTITYPE] = sGen4PlaceholderDescription,
    [ABILITY_NO_GUARD] = sGen4PlaceholderDescription,
    [ABILITY_NORMALIZE] = sGen4PlaceholderDescription,
    [ABILITY_POISON_HEAL] = sGen4PlaceholderDescription,
    [ABILITY_QUICK_FEET] = sGen4PlaceholderDescription,
    [ABILITY_RECKLESS] = sGen4PlaceholderDescription,
    [ABILITY_RIVALRY] = sGen4PlaceholderDescription,
    [ABILITY_SCRAPPY] = sGen4PlaceholderDescription,
    [ABILITY_SIMPLE] = sGen4PlaceholderDescription,
    [ABILITY_SKILL_LINK] = sGen4PlaceholderDescription,
    [ABILITY_SLOW_START] = sGen4PlaceholderDescription,
    [ABILITY_SNIPER] = sGen4PlaceholderDescription,
    [ABILITY_SNOW_CLOAK] = sGen4PlaceholderDescription,
    [ABILITY_SNOW_WARNING] = sGen4PlaceholderDescription,
    [ABILITY_SOLAR_POWER] = sGen4PlaceholderDescription,
    [ABILITY_SOLID_ROCK] = sGen4PlaceholderDescription,
    [ABILITY_STALL] = sGen4PlaceholderDescription,
    [ABILITY_STEADFAST] = sGen4PlaceholderDescription,
    [ABILITY_STORM_DRAIN] = sGen4PlaceholderDescription,
    [ABILITY_SUPER_LUCK] = sGen4PlaceholderDescription,
    [ABILITY_TANGLED_FEET] = sGen4PlaceholderDescription,
    [ABILITY_TECHNICIAN] = sGen4PlaceholderDescription,
    [ABILITY_TINTED_LENS] = sGen4PlaceholderDescription,
    [ABILITY_UNAWARE] = sGen4PlaceholderDescription,
    [ABILITY_UNBURDEN] = sGen4PlaceholderDescription,
};
