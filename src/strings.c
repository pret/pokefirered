...
const u8 gText_Clefairy_500Coins[] = _("CLEFFA{CLEAR_TO 0x55}{FONT_SMALL} 500 COINS");
...
const u8 gText_Clefairy_750Coins[] = _("CLEFFA{CLEAR_TO 0x55}{FONT_SMALL} 750 COINS");
