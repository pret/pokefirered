...
_08074A64: .4byte gUnknown_2023D44
	thumb_func_end sub_80749D4

	thumb_func_start sub_8074A68
sub_8074A68: @ 8074A68
	strh r1, [r0, 0x3A]
	lsrs r1, 16
	strh r1, [r0, 0x3C]
	bx lr
	thumb_func_end sub_8074A68
...
sub_8074DC4: @ 8074DC4
	...
	subs r0, r1, 0x1
	strh r0, [r3, 0x2E]
	ldr r2, _08074E04 @ =gUnknown_202063C
	movs r4, 0x34
	ldrsh r1, [r3, r4]
	lsls r0, r1, 4
	adds r0, r1
...
sub_8074E14: @ 8074E14
	...
	adds r0, r2
	strh r0, [r4, 0x36]
	ldr r3, _08074E60 @ =gUnknown_202063C
	movs r0, 0x38
	ldrsh r2, [r4, r0]
	lsls r0, r2, 4
	adds r0, r2
...
_080751E4: .4byte gUnknown_2023BD6
	thumb_func_end sub_80751D8

	thumb_func_start sub_80751E8
sub_80751E8: @ 80751E8
	push {r4,lr}
	lsls r0, 24
	lsrs r3, r0, 24
...
sub_8075858: @ 8075858
	...
	str r1, [sp]
_08075894:
	ldr r1, _080758D4 @ =gUnknown_202063C
	lsls r0, r4, 4
	adds r0, r4
	lsls r0, 2
	adds r0, r1
	...
	movs r3, 0x2
	bl ObjAffineSet
	ldr r0, _080758D8 @ =gUnknown_2021BCC
	lsls r4, 3
	adds r4, r0
	ldrh r0, [r5]
	strh r0, [r4]
...
_080758D4: .4byte gUnknown_202063C
_080758D8: .4byte gUnknown_2021BCC
	thumb_func_end sub_8075858
...
sub_80758E0: @ 80758E0
	...
	lsls r1, 24
	lsrs r5, r1, 24
	ldr r2, _08075978 @ =gUnknown_202063C
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r4, r1, r2
...
_0807595C:
	...
	bx r0
	.align 2, 0
_08075978: .4byte gUnknown_202063C
...
sub_8075980: @ 8075980
	...
	movs r3, 0
	bl sub_8075858
	ldr r1, _080759D8 @ =gUnknown_202063C
	lsls r0, r4, 4
	adds r0, r4
	lsls r0, 2
	adds r0, r1
	...
	bx r0
	.align 2, 0
_080759D8: .4byte gUnknown_202063C
...
sub_80759DC: @ 80759DC
	...
	lsls r0, 24
	lsrs r0, 24
	ldr r2, _08075A14 @ =gUnknown_202063C
	lsls r1, r0, 4
	adds r1, r0
	lsls r1, 2
	adds r2, r1, r2
	...
	lsls r0, 26
	lsrs r0, 27
	ldr r1, _08075A18 @ =gUnknown_2021BCC
	lsls r0, 3
	adds r0, r1
	ldrh r1, [r0, 0x4]
	movs r3, 0x4
...
_08075A08:
	...
	bx r0
	.align 2, 0
_08075A14: .4byte gUnknown_202063C
_08075A18: .4byte gUnknown_2021BCC
...
_08075A98:
	...
	movs r3, 0x2
	bl ObjAffineSet
	ldr r0, _08075AD4 @ =gUnknown_2021BCC
	lsls r4, 3
	adds r4, r0
	ldrh r0, [r5]
	strh r0, [r4]
...
_08075AD4: .4byte gUnknown_2021BCC
...
sub_8075FBC: @ 8075FBC
	...
	beq _08076026
	movs r6, 0
	ldr r2, _08076018 @ =gUnknown_202063C
	lsls r0, r1, 4
	adds r0, r1
	lsls r1, r0, 2
_08075FD8:
	...
	b _0807602A
	.align 2, 0
_08076018: .4byte gUnknown_202063C
_0807601C:
	adds r0, r6, 0x1
	lsls r0, 16
	lsrs r6, r0, 16
...
_0807602A:
	...
	pop {r1}
	bx r1
	thumb_func_end sub_8075FBC

	thumb_func_start sub_8076030
sub_8076030: @ 8076030
	push {lr}
	adds r3, r0, 0
	adds r3, 0x3F
...
_08076190:
	...
	lsls r0, 3
	adds r0, r1
	ldr r2, _080761C0 @ =gUnknown_202063C
	lsls r1, r3, 4
	adds r1, r3
	lsls r1, 2
	adds r1, r2
...
_080761C0: .4byte gUnknown_202063C
...
_08076408:
	...
	b _08076436
_08076410:
	ldr r2, _08076430 @ =gUnknown_202063C
	movs r0, 0x26
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
	...
	b _08076438
	.align 2, 0
_08076430: .4byte gUnknown_202063C
_08076434:
	strh r2, [r4, 0x16]
_08076436:
	movs r0, 0x1
...
sub_8076440: @ 8076440
	...
	movs r1, 0x40
	subs r5, r1, r0
	ldr r1, _0807648C @ =gUnknown_202063C
	lsls r0, r4, 4
	adds r0, r4
	lsls r0, 2
	adds r4, r0, r1
	...
	lsrs r1, 27
	lsls r0, r5, 8
	ldr r2, _08076490 @ =gUnknown_2021BCC
	lsls r1, 3
	adds r1, r2
	movs r2, 0x6
	ldrsh r1, [r1, r2]
...
_0807647C:
	...
	bx r0
	.align 2, 0
_0807648C: .4byte gUnknown_202063C
_08076490: .4byte gUnknown_2021BCC
...
sub_8076494: @ 8076494
	...
	movs r1, 0x40
	subs r5, r1, r0
	ldr r1, _080764E4 @ =gUnknown_202063C
	lsls r0, r4, 4
	adds r0, r4
	lsls r0, 2
	adds r4, r0, r1
	...
	lsrs r1, 27
	lsls r0, r5, 8
	ldr r2, _080764E8 @ =gUnknown_2021BCC
	lsls r1, 3
	adds r1, r2
	movs r2, 0x6
	ldrsh r1, [r1, r2]
...
_080764D4:
	...
	bx r0
	.align 2, 0
_080764E4: .4byte gUnknown_202063C
_080764E8: .4byte gUnknown_2021BCC
...
sub_80764EC: @ 80764EC
	...
	lsls r0, 24
	lsrs r2, r0, 24
	ldr r1, _08076548 @ =gUnknown_202063C
	lsls r0, r2, 4
	adds r0, r2
	lsls r0, 2
	adds r0, r1
...
_08076508:
	...
	b _0807655E
	.align 2, 0
_08076548: .4byte gUnknown_202063C
...
_08076672:
	...
	b _080766AC
_0807669C:
	ldr r2, _080766B4 @ =gUnknown_202063C
	movs r0, 0x26
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_080766AE:
	...
	bx r1
	.align 2, 0
_080766B4: .4byte gUnknown_202063C
...
sub_80766EC: @ 80766EC
	...
	cmp r0, 0
	beq _0807672C
	ldr r2, _080767E4 @ =gUnknown_202063C
...
_080767E4: .4byte gUnknown_202063C
...
sub_80767F0: @ 80767F0
	...
	cmp r5, r0
	bge _0807684A
	ldr r6, _08076854 @ =gUnknown_202063C
_080767FE:
	lsls r0, r5, 24
	lsrs r4, r0, 24
	adds r0, r4, 0
...
_08076854: .4byte gUnknown_202063C
...
sub_8076E34: @ 8076E34
	...
	lsrs r0, 24
	mov r8, r0
	ldr r0, _08076ED0 @ =gUnknown_202063C
	mov r9, r0
	mov r0, r8
	lsls r3, r0, 4
	add r3, r8
	...
	bx r1
	.align 2, 0
_08076ECC: .4byte nullsub_8
_08076ED0: .4byte gUnknown_202063C
...
_08077064:
	...
	strh r6, [r5, 0xC]
	strh r6, [r5, 0xE]
	ldr r4, _080770CC @ =gUnknown_202063C
	movs r0, 0x8
	ldrsh r1, [r5, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_080770CC: .4byte gUnknown_202063C
...
_08077146:
	...
	adds r1, r5, 0
	bl sub_80771E4
	ldr r2, _08077178 @ =gUnknown_202063C
	movs r0, 0x8
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
	...
	b _080771B6
	.align 2, 0
_08077178: .4byte gUnknown_202063C
_0807717C:
	adds r0, r4, 0
	adds r1, r5, 0
	bl sub_80771E4
	ldr r3, _080771C0 @ =gUnknown_202063C
	movs r0, 0x8
	ldrsh r1, [r4, r0]
	lsls r0, r1, 4
	adds r0, r1
...
_080771B6:
	...
	b _080771D8
	.align 2, 0
_080771C0: .4byte gUnknown_202063C
_080771C4:
	movs r2, 0x12
	ldrsh r0, [r4, r2]
	cmp r0, 0
...
sub_80771E4: @ 80771E4
	...
	cmp r0, 0
	blt _08077254
	ldr r5, _08077260 @ =gUnknown_202063C
	lsls r4, r0, 4
	adds r4, r0
	lsls r4, 2
	adds r3, r4, r5
...
_08077254:
	...
	bx r0
	.align 2, 0
_08077260: .4byte gUnknown_202063C
