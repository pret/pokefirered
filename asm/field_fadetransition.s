...
sub_807E980: @ 807E980
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0807E9CC @ =gUnknown_202063C
	adds r7, r0, r1
	movs r1, 0
	ldrsh r0, [r5, r1]
	cmp r0, 0x1
...
_0807E9CC: .4byte gUnknown_202063C
_0807E9D0:
	cmp r0, 0x2
	beq _0807EA38
	cmp r0, 0x3
...
sub_807EAC4: @ 807EAC4
	...
	adds r0, r2
	lsls r0, 2
	ldr r2, _0807EB5C @ =gUnknown_202063C
	adds r7, r0, r2
	ldrb r2, [r3, 0x5]
	lsls r0, r2, 3
	adds r0, r2
...
_0807EB5C: .4byte gUnknown_202063C
...
_0807ED0C:
	...
	adds r1, r0
	lsls r1, 2
	ldr r0, _0807ED9C @ =gUnknown_202063C
	adds r1, r0
	mov r2, r9
	ldrh r0, [r2]
	lsls r0, 16
...
_0807ED9C: .4byte gUnknown_202063C
...
sub_807EDA0: @ 807EDA0
	...
	adds r0, r1
	lsls r0, 2
	ldr r1, _0807EDCC @ =gUnknown_202063C
	adds r1, r0, r1
	movs r7, 0
	ldrsh r0, [r4, r7]
	cmp r0, 0
...
_0807EDCC: .4byte gUnknown_202063C
_0807EDD0:
	ldrh r0, [r5]
	ldrh r5, [r2]
	adds r0, r5
