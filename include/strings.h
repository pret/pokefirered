...
extern const u8 gText_RetrainPkmn[];
...
extern const u8 gText_MenuTrainerTypeLevels[];
...
extern const u8 gStartMenuDesc_TrainerTypeLevels[];
extern const u8 gStartMenuDesc_Player[];
extern const u8 gText_SaveError_PleaseExchangeBackupMemory[];
extern const u8 gText_TTL_Page[];
extern const u8 gText_TTL_Level[];
extern const u8 gText_PressAToChange[];
extern const u8 gText_PressB[];
extern const u8 gTrainerTypeNames[][9];
extern const u8 gText_TTLSummaryHeader[];
extern const u8 gText_TTLSummaryExp[];
extern const u8 gText_TTLSummaryLevelUp[];
