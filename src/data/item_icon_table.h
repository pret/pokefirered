static const u32 *const sItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_RM_1_KEY]     = {gItemIcon_Room1Key, gItemIconPalette_Key},
    [ITEM_RM_2_KEY]     = {gItemIcon_Room2Key, gItemIconPalette_Key},
    [ITEM_RM_4_KEY]     = {gItemIcon_Room4Key, gItemIconPalette_Key},
    [ITEM_RM_6_KEY]     = {gItemIcon_Room6Key, gItemIconPalette_Key},
